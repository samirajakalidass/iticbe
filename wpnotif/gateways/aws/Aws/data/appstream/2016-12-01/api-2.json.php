...
return [
	...
	'operations' => [
		...
		'BatchAssociateUserStack'          => [
			...
			'errors' => [ [ 'shape' => 'OperationNotPermittedException', ], ],
		],
	...
	'shapes'     => [
		'AccountName'                              => [ 'type' => 'string', 'min' => 1, 'sensitive' => true, ],
		'AccountPassword'                          => [
			'type'      => 'string',
			'max'       => 127,
			'min'       => 1,
		...
		'AppstreamAgentVersion'                    => [ 'type' => 'string', 'max' => 100, 'min' => 1, ],
		'Arn'                                      => [
			'type'    => 'string',
		...
		'AwsAccountId'                             => [ 'type' => 'string', 'pattern' => '^\\d+$', ],
		'AwsAccountIdList'                         => [
			'type'   => 'list',
		...
		'BatchAssociateUserStackRequest'           => [
			...
			'members'  => [ 'UserStackAssociations' => [ 'shape' => 'UserStackAssociationList', ], ],
		],
		'BatchAssociateUserStackResult'            => [
			'type'    => 'structure',
			'members' => [ 'errors' => [ 'shape' => 'UserStackAssociationErrorList', ], ],
		],
		...
		'CopyImageResponse'                        => [
			'type'    => 'structure',
			'members' => [ 'DestinationImageName' => [ 'shape' => 'Name', ], ],
		],
		...
		'CreateUsageReportSubscriptionRequest'     => [ 'type' => 'structure', 'members' => [], ],
		...
		'CreateUserResult'                         => [ 'type' => 'structure', 'members' => [], ],
		...
		'DeleteImagePermissionsResult'             => [ 'type' => 'structure', 'members' => [], ],
		'DeleteImageRequest'                       => [
			'type'     => 'structure',
			'required' => [ 'Name', ],
			'members'  => [ 'Name' => [ 'shape' => 'Name', ], ],
		...
		'DeleteUsageReportSubscriptionRequest'     => [ 'type' => 'structure', 'members' => [], ],
		'DeleteUsageReportSubscriptionResult'      => [ 'type' => 'structure', 'members' => [], ],
		'DeleteUserRequest'                        => [
			'type'     => 'structure',
			'required' => [ 'UserName', 'AuthenticationType', ],
			'members'  => [
		...
		'DeleteUserResult'                         => [ 'type' => 'structure', 'members' => [], ],
		...
		'DescribeImagesMaxResults'                 => [ 'type' => 'integer', 'box' => true, 'max' => 25, 'min' => 0, ],
		...
		'DisableUserResult'                        => [ 'type' => 'structure', 'members' => [], ],
		...
		'EnableUserResult'                         => [ 'type' => 'structure', 'members' => [], ],
		...
		'FeedbackURL'                              => [ 'type' => 'string', 'max' => 1000, ],
		'Fleet'                                    => [
			'type'     => 'structure',
			'required' => [
				'Arn',
		...
		'ImageBuilderStateChangeReasonCode'        => [
			'type' => 'string',
			'enum' => [ 'INTERNAL_ERROR', 'IMAGE_UNAVAILABLE', ],
		],
		...
		'Long'                                     => [ 'type' => 'long', ],
		'MaxResults'                               => [ 'type' => 'integer', 'box' => true, 'max' => 500, 'min' => 0, ],
		'MessageAction'                            => [ 'type' => 'string', 'enum' => [ 'SUPPRESS', 'RESEND', ], ],
		'Metadata'                                 => [
			'type'  => 'map',
			'key'   => [ 'shape' => 'String', ],
			'value' => [ 'shape' => 'String', ],
		...
		'Permission'                               => [ 'type' => 'string', 'enum' => [ 'ENABLED', 'DISABLED', ], ],
		'PlatformType'                             => [
			'type' => 'string',
			'enum' => [
				'WINDOWS',
		...
		'RedirectURL'                              => [ 'type' => 'string', 'max' => 1000, ],
		'RegionName'                               => [ 'type' => 'string', 'max' => 32, 'min' => 1, ],
		...
		'SettingsGroup'                            => [ 'type' => 'string', 'max' => 100, ],
		...
		'UpdateImagePermissionsResult'             => [ 'type' => 'structure', 'members' => [], ],
		'UpdateStackRequest'                       => [
			'type'     => 'structure',
			'required' => [ 'Name', ],
			'members'  => [
		...
		'UsageReportSchedule'                      => [ 'type' => 'string', 'enum' => [ 'DAILY', ], ],
