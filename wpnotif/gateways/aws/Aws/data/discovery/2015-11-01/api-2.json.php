...
return [
	...
	'shapes'     => [
		...
		'BatchDeleteImportDataRequest'                          => [
			...
			'members'  => [ 'importTaskIds' => [ 'shape' => 'ToDeleteIdentifierList', ], ],
		],
		'BatchDeleteImportDataResponse'                         => [
			'type'    => 'structure',
			'members' => [ 'errors' => [ 'shape' => 'BatchDeleteImportDataErrorList', ], ],
		],
		'Boolean'                                               => [ 'type' => 'boolean', ],
		'BoxedInteger'                                          => [ 'type' => 'integer', 'box' => true, ],
		'ClientRequestToken'                                    => [ 'type' => 'string', 'max' => 100, 'min' => 1, ],
		...
		'DataSource'                                            => [ 'type' => 'string', 'enum' => [ 'AGENT', ], ],
		'DatabaseName'                                          => [ 'type' => 'string', 'max' => 252, 'min' => 1, ],
		...
		'ImportTaskFilterName'                                  => [
			'type' => 'string',
			'enum' => [ 'IMPORT_TASK_ID', 'STATUS', 'NAME', ],
		],
		'ImportTaskFilterValue'                                 => [ 'type' => 'string', 'max' => 100, 'min' => 1, ],
		...
		'ImportTaskName'                                        => [ 'type' => 'string', 'max' => 100, 'min' => 1, ],
		'ImportURL'                                             => [ 'type' => 'string', 'max' => 4000, 'min' => 1, ],
		...
		'StartContinuousExportRequest'                          => [ 'type' => 'structure', 'members' => [], ],
		...
		'String'                                                => [ 'type' => 'string', ],
		'StringMax255'                                          => [ 'type' => 'string', 'max' => 255, 'min' => 1, ],
		'Tag'                                                   => [
			'type'     => 'structure',
			'required' => [ 'key', 'value', ],
			'members'  => [
