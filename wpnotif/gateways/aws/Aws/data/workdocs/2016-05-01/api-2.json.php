...
return [
	...
	'shapes'     => [
		...
		'BooleanEnumType'                           => [ 'type' => 'string', 'enum' => [ 'TRUE', 'FALSE', ], ],
		...
		'GetDocumentPathResponse'                   => [
			'type'    => 'structure',
			'members' => [ 'Path' => [ 'shape' => 'ResourcePath', ], ],
		],
		'GetDocumentRequest'                        => [
			'type'     => 'structure',
			'required' => [ 'DocumentId', ],
		...
		'PositiveIntegerType'                       => [ 'type' => 'integer', 'min' => 1, ],
		...
		'ResourceCollectionType'                    => [ 'type' => 'string', 'enum' => [ 'SHARED_WITH_ME', ], ],
		'ResourceIdType'                            => [
			'type'    => 'string',
			'max'     => 128,
			'min'     => 1,
