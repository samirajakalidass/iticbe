...
return [
	...
	'shapes'     => [
		...
		'CreateEndpointResponse'                           => [
			'type'    => 'structure',
			'members' => [ 'Endpoint' => [ 'shape' => 'Endpoint', ], ],
		],
		...
		'DataFormatValue'                                  => [ 'type' => 'string', 'enum' => [ 'csv', 'parquet', ], ],
		...
		'Long'                                             => [ 'type' => 'long', ],
		'MessageFormatValue'                               => [ 'type' => 'string', 'enum' => [ 'json', ], ],
		'MigrationTypeValue'                               => [
			'type' => 'string',
		...
		'RefreshSchemasStatusTypeValue'                    => [
			'type' => 'string',
			'enum' => [ 'successful', 'failed', 'refreshing', ],
		],
		'ReleaseStatusValues'                              => [ 'type' => 'string', 'enum' => [ 'beta', ], ],
		'ReloadOptionValue'                                => [
			'type' => 'string',
			'enum' => [ 'data-reload', 'validate-only', ],
		],
		'ReloadTablesMessage'                              => [
			'type'     => 'structure',
			'required' => [
