...
return [
	...
	'shapes'     => [
		...
		'CreateGroupResponse'                           => [
			'type'    => 'structure',
			'members' => [ 'GroupId' => [ 'shape' => 'WorkMailIdentifier', ], ],
		],
		...
		'CreateResourceResponse'                        => [
			'type'    => 'structure',
			'members' => [ 'ResourceId' => [ 'shape' => 'ResourceId', ], ],
		],
		'CreateUserRequest'                             => [
			'type'     => 'structure',
			'required' => [
		...
		'CreateUserResponse'                            => [
			'type'    => 'structure',
			'members' => [ 'UserId' => [ 'shape' => 'WorkMailIdentifier', ], ],
		],
		'Delegate'                                      => [
			'type'     => 'structure',
			'required' => [ 'Id', 'Type', ],
		...
		'DeleteMailboxPermissionsResponse'              => [ 'type' => 'structure', 'members' => [], ],
		...
		'MailboxQuota'                                  => [ 'type' => 'integer', 'box' => true, 'min' => 1, ],
		'MailboxSize'                                   => [ 'type' => 'double', 'min' => 0, ],
		'MaxResults'                                    => [
			'type' => 'integer',
			'box'  => true,
			'max'  => 100,
		...
		'PutMailboxPermissionsResponse'                 => [ 'type' => 'structure', 'members' => [], ],
		...
		'ResetPasswordResponse'                         => [ 'type' => 'structure', 'members' => [], ],
		'Resource'                                      => [
			'type'    => 'structure',
			'members' => [
				'Id'           => [ 'shape' => 'WorkMailIdentifier', ],
		...
		'UpdateMailboxQuotaResponse'                    => [ 'type' => 'structure', 'members' => [], ],
		...
		'UpdateResourceResponse'                        => [ 'type' => 'structure', 'members' => [], ],
		'User'                                          => [
			'type'    => 'structure',
			'members' => [
				'Id'           => [ 'shape' => 'WorkMailIdentifier', ],
