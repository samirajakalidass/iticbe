...
return [
	...
	'shapes'     => [
		...
		'CreateCloudFormationStackRequest'                     => [
			'type'     => 'structure',
			'required' => [ 'instances', ],
			'members'  => [ 'instances' => [ 'shape' => 'InstanceEntryList', ], ],
		],
		...
		'DeleteRelationalDatabaseSnapshotRequest'              => [
			...
			'members'  => [ 'relationalDatabaseSnapshotName' => [ 'shape' => 'ResourceName', ], ],
		],
		...
		'DiskSnapshotInfo'                                     => [
			'type'    => 'structure',
			'members' => [ 'sizeInGb' => [ 'shape' => 'integer', ], ],
		],
		'DiskSnapshotList'                                     => [
			'type'   => 'list',
		...
		'ExportSnapshotRecordSourceType'                       => [
			'type' => 'string',
			'enum' => [ 'InstanceSnapshot', 'DiskSnapshot', ],
		],
		'ExportSnapshotRequest'                                => [
			'type'     => 'structure',
			'required' => [ 'sourceSnapshotName', ],
			'members'  => [ 'sourceSnapshotName' => [ 'shape' => 'ResourceName', ], ],
		],
		...
		'GetDiskSnapshotResult'                                => [
			'type'    => 'structure',
			'members' => [ 'diskSnapshot' => [ 'shape' => 'DiskSnapshot', ], ],
		],
		...
		'GetInstanceStateResult'                               => [
			'type'    => 'structure',
			'members' => [ 'state' => [ 'shape' => 'InstanceState', ], ],
		],
		'GetInstancesRequest'                                  => [
			'type'    => 'structure',
			'members' => [ 'pageToken' => [ 'shape' => 'string', ], ],
		...
		'GetLoadBalancerResult'                                => [
			'type'    => 'structure',
			'members' => [ 'loadBalancer' => [ 'shape' => 'LoadBalancer', ], ],
		],
		...
		'GetRegionsResult'                                     => [
			'type'    => 'structure',
			'members' => [ 'regions' => [ 'shape' => 'RegionList', ], ],
		],
		...
		'GetRelationalDatabaseLogStreamsRequest'               => [
			'type'     => 'structure',
			'required' => [ 'relationalDatabaseName', ],
			'members'  => [ 'relationalDatabaseName' => [ 'shape' => 'ResourceName', ], ],
		],
		'GetRelationalDatabaseLogStreamsResult'                => [
			'type'    => 'structure',
			'members' => [ 'logStreams' => [ 'shape' => 'StringList', ], ],
		],
		...
		'GetRelationalDatabaseResult'                          => [
			'type'    => 'structure',
			'members' => [ 'relationalDatabase' => [ 'shape' => 'RelationalDatabase', ], ],
		],
		...
		'GetRelationalDatabaseSnapshotResult'                  => [
			'type'    => 'structure',
			'members' => [ 'relationalDatabaseSnapshot' => [ 'shape' => 'RelationalDatabaseSnapshot', ], ],
		],
		...
		'GetStaticIpResult'                                    => [
			'type'    => 'structure',
			'members' => [ 'staticIp' => [ 'shape' => 'StaticIp', ], ],
		],
		'GetStaticIpsRequest'                                  => [
			'type'    => 'structure',
			'members' => [ 'pageToken' => [ 'shape' => 'string', ], ],
		...
		'IsVpcPeeredResult'                                    => [
			'type'    => 'structure',
			'members' => [ 'isPeered' => [ 'shape' => 'boolean', ], ],
		],
		...
		'MonthlyTransfer'                                      => [
			'type'    => 'structure',
			'members' => [ 'gbPerMonthAllocated' => [ 'shape' => 'integer', ], ],
		],
		'NetworkProtocol'                                      => [
			'type' => 'string',
			'enum' => [ 'tcp', 'all', 'udp', ],
		...
		'RelationalDatabaseEngine'                             => [ 'type' => 'string', 'enum' => [ 'mysql', ], ],
