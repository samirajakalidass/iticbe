<?php
// This file was auto-generated from sdk-root/src/data/eventbridge/2015-10-07/api-2.json
return [
	'version'    => '2.0',
	'metadata'   => [
	...
	'shapes'     => [
		...
		'ActivateEventSourceRequest'             => [
			'type'     => 'structure',
			'required' => [ 'Name', ],
			'members'  => [ 'Name' => [ 'shape' => 'EventSourceName', ], ],
		],
		...
		'BatchRetryStrategy'                     => [
			'type'    => 'structure',
			'members' => [ 'Attempts' => [ 'shape' => 'Integer', ], ],
		],
		...
		'CreateEventBusResponse'                 => [
			'type'    => 'structure',
			'members' => [ 'EventBusArn' => [ 'shape' => 'String', ], ],
		],
		...
		'CreatePartnerEventSourceResponse'       => [
			'type'    => 'structure',
			'members' => [ 'EventSourceArn' => [ 'shape' => 'String', ], ],
		],
		...
		'DeleteEventBusRequest'                  => [
			'type'     => 'structure',
			'required' => [ 'Name', ],
			'members'  => [ 'Name' => [ 'shape' => 'EventBusName', ], ],
		],
		...
		'EventBusList'                           => [ 'type' => 'list', 'member' => [ 'shape' => 'EventBus', ], ],
		'EventBusName'                           => [
			'type'    => 'string',
			'max'     => 256,
			'min'     => 1,
		...
		'EventSourceList'                        => [ 'type' => 'list', 'member' => [ 'shape' => 'EventSource', ], ],
		'EventSourceName'                        => [
			'type'    => 'string',
			'max'     => 256,
			'min'     => 1,
		...
		'ManagedBy'                              => [ 'type' => 'string', 'max' => 128, 'min' => 1, ],
		'ManagedRuleException'                   => [ 'type' => 'structure', 'members' => [], 'exception' => true, ],
		...
		'PutPartnerEventsRequest'                => [
			'type'     => 'structure',
			'required' => [ 'Entries', ],
			'members'  => [ 'Entries' => [ 'shape' => 'PutPartnerEventsRequestEntryList', ], ],
		],
		...
		'SqsParameters'                          => [
			'type'    => 'structure',
			'members' => [ 'MessageGroupId' => [ 'shape' => 'MessageGroupId', ], ],
		],
		'StatementId'                            => [
			'type'    => 'string',
			'max'     => 64,
