...
return [
	...
	'shapes'     => [
		...
		'ClusterSettingName'                             => [ 'type' => 'string', 'enum' => [ 'containerInsights', ], ],
		'ClusterSettings'                                => [
			'type'   => 'list',
		...
		'ContainerInstanceField'                         => [ 'type' => 'string', 'enum' => [ 'TAGS', ], ],
		...
		'DeploymentController'                           => [
			'type'     => 'structure',
			'required' => [ 'type', ],
			'members'  => [ 'type' => [ 'shape' => 'DeploymentControllerType', ], ],
		],
		...
		'GpuIds'                                         => [ 'type' => 'list', 'member' => [ 'shape' => 'String', ], ],
		'HealthCheck'                                    => [
			'type'     => 'structure',
			'required' => [ 'command', ],
			'members'  => [
		...
		'HostVolumeProperties'                           => [
			'type'    => 'structure',
			'members' => [ 'sourcePath' => [ 'shape' => 'String', ], ],
		],
		...
		'LaunchType'                                     => [ 'type' => 'string', 'enum' => [ 'EC2', 'FARGATE', ], ],
		'LinuxParameters'                                => [
			'type'    => 'structure',
			'members' => [
		...
		'PidMode'                                        => [ 'type' => 'string', 'enum' => [ 'host', 'task', ], ],
		'PlacementConstraint'                            => [
			'type'    => 'structure',
			'members' => [
		...
		'PlatformDeviceType'                             => [ 'type' => 'string', 'enum' => [ 'GPU', ], ],
		'PlatformDevices'                                => [
			'type'   => 'list',
		...
		'ProxyConfigurationType'                         => [ 'type' => 'string', 'enum' => [ 'APPMESH', ], ],
		...
		'RepositoryCredentials'                          => [
			...
			'members'  => [ 'credentialsParameter' => [ 'shape' => 'String', ], ],
		],
		'RequiresAttributes'                             => [
			'type'   => 'list',
			'member' => [ 'shape' => 'Attribute', ],
		...
		'ResourceType'                                   => [ 'type' => 'string', 'enum' => [ 'GPU', ], ],
		'Resources'                                      => [
			'type'   => 'list',
		...
		'ScaleUnit'                                      => [ 'type' => 'string', 'enum' => [ 'PERCENT', ], ],
		'SchedulingStrategy'                             => [ 'type' => 'string', 'enum' => [ 'REPLICA', 'DAEMON', ], ],
		'Scope'                                          => [ 'type' => 'string', 'enum' => [ 'task', 'shared', ], ],
		'Secret'                                         => [
			'type'     => 'structure',
		...
		'SecretList'                                     => [ 'type' => 'list', 'member' => [ 'shape' => 'Secret', ], ],
		'ServerException'                                => [
			'type'      => 'structure',
			'members'   => [ 'message' => [ 'shape' => 'String', ], ],
			'exception' => true,
		...
		'ServiceField'                                   => [ 'type' => 'string', 'enum' => [ 'TAGS', ], ],
		'ServiceFieldList'                               => [
			'type'   => 'list',
		...
		'TaskDefinitionField'                            => [ 'type' => 'string', 'enum' => [ 'TAGS', ], ],
		...
		'TaskField'                                      => [ 'type' => 'string', 'enum' => [ 'TAGS', ], ],
		'TaskFieldList'                                  => [
			'type'   => 'list',
		...
		'TmpfsList'                                      => [ 'type' => 'list', 'member' => [ 'shape' => 'Tmpfs', ], ],
