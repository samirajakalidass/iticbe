	...
	'partitions' => [
		[
			...
			'services'      => [
				...
				'groundstation'                => [ 'endpoints' => [ 'us-east-2' => [], 'us-west-2' => [], ], ],
				'guardduty'                    => [
					'defaults'       => [ 'protocols' => [ 'https', ], ],
					'endpoints'      => [
						'ap-northeast-1' => [],
		...
		[
			...
			'services'      => [
				...
				'apigateway'              => [ 'endpoints' => [ 'cn-north-1' => [], 'cn-northwest-1' => [], ], ],
				'application-autoscaling' => [
					'defaults'  => [
						'credentialScope' => [ 'service' => 'application-autoscaling', ],
						'hostname'        => 'autoscaling.{region}.amazonaws.com',
				...
				'codebuild'               => [ 'endpoints' => [ 'cn-north-1' => [], 'cn-northwest-1' => [], ], ],
				...
				'dms'                     => [ 'endpoints' => [ 'cn-north-1' => [], 'cn-northwest-1' => [], ], ],
				'ds'                      => [ 'endpoints' => [ 'cn-north-1' => [], 'cn-northwest-1' => [], ], ],
				'dynamodb'                => [
					'defaults'  => [ 'protocols' => [ 'http', 'https', ], ],
					'endpoints' => [ 'cn-north-1' => [], 'cn-northwest-1' => [], ],
				],
				...
				'es'                      => [ 'endpoints' => [ 'cn-north-1' => [], 'cn-northwest-1' => [], ], ],
				'events'                  => [ 'endpoints' => [ 'cn-north-1' => [], 'cn-northwest-1' => [], ], ],
				'firehose'                => [ 'endpoints' => [ 'cn-north-1' => [], 'cn-northwest-1' => [], ], ],
				...
				'kms'                     => [ 'endpoints' => [ 'cn-north-1' => [], 'cn-northwest-1' => [], ], ],
				'lambda'                  => [ 'endpoints' => [ 'cn-north-1' => [], 'cn-northwest-1' => [], ], ],
				'license-manager'         => [ 'endpoints' => [ 'cn-north-1' => [], 'cn-northwest-1' => [], ], ],
				...
				'states'                  => [ 'endpoints' => [ 'cn-north-1' => [], 'cn-northwest-1' => [], ], ],
		...
		[
			...
			'regions'       => [
				...
				'us-gov-west-1' => [ 'description' => 'AWS GovCloud (US)', ],
			],
			'services'      => [
				...
				'api.sagemaker'           => [ 'endpoints' => [ 'us-gov-west-1' => [], ], ],
				'apigateway'              => [ 'endpoints' => [ 'us-gov-east-1' => [], 'us-gov-west-1' => [], ], ],
				'application-autoscaling' => [ 'endpoints' => [ 'us-gov-east-1' => [], 'us-gov-west-1' => [], ], ],
				'athena'                  => [ 'endpoints' => [ 'us-gov-east-1' => [], 'us-gov-west-1' => [], ], ],
				'autoscaling'             => [
					'endpoints' => [
						'us-gov-east-1' => [],
						'us-gov-west-1' => [
				...
				'codebuild'               => [ 'endpoints' => [ 'us-gov-east-1' => [], 'us-gov-west-1' => [], ], ],
				'codecommit'              => [ 'endpoints' => [ 'us-gov-east-1' => [], 'us-gov-west-1' => [], ], ],
				'codedeploy'              => [
					'endpoints' => [
						'us-gov-east-1'      => [],
						'us-gov-east-1-fips' => [
				...
				'ecs'                     => [ 'endpoints' => [ 'us-gov-east-1' => [], 'us-gov-west-1' => [], ], ],
				'elasticache'             => [
					'endpoints' => [
						'fips'          => [
							'credentialScope' => [ 'region' => 'us-gov-west-1', ],
				...
				'elasticfilesystem'       => [ 'endpoints' => [ 'us-gov-west-1' => [], ], ],
				'elasticloadbalancing'    => [
					'endpoints' => [
						'us-gov-east-1' => [],
						'us-gov-west-1' => [
				...
				'firehose'                => [ 'endpoints' => [ 'us-gov-east-1' => [], 'us-gov-west-1' => [], ], ],
				'glacier'                 => [
					'endpoints' => [
						'us-gov-east-1' => [],
						'us-gov-west-1' => [
				...
				'glue'                    => [ 'endpoints' => [ 'us-gov-east-1' => [], 'us-gov-west-1' => [], ], ],
				'greengrass'              => [
					'defaults'       => [ 'protocols' => [ 'https', ], ],
					'endpoints'      => [ 'us-gov-west-1' => [], ],
					'isRegionalized' => true,
				...
				'inspector'               => [ 'endpoints' => [ 'us-gov-east-1' => [], 'us-gov-west-1' => [], ], ],
				'iot'                     => [
					'defaults'  => [ 'credentialScope' => [ 'service' => 'execute-api', ], ],
					'endpoints' => [ 'us-gov-west-1' => [], ],
				],
				...
				'license-manager'         => [ 'endpoints' => [ 'us-gov-east-1' => [], 'us-gov-west-1' => [], ], ],
				'logs'                    => [ 'endpoints' => [ 'us-gov-east-1' => [], 'us-gov-west-1' => [], ], ],
				'mediaconvert'            => [ 'endpoints' => [ 'us-gov-west-1' => [], ], ],
				'metering.marketplace'    => [
					'defaults'  => [ 'credentialScope' => [ 'service' => 'aws-marketplace', ], ],
					'endpoints' => [ 'us-gov-west-1' => [], ],
				],
				...
				'runtime.sagemaker'       => [ 'endpoints' => [ 'us-gov-west-1' => [], ], ],
				's3'                      => [
				...
				'serverlessrepo'          => [
					'defaults'  => [ 'protocols' => [ 'https', ], ],
					'endpoints' => [ 'us-gov-west-1' => [ 'protocols' => [ 'https', ], ], ],
				],
				...
				'states'                  => [ 'endpoints' => [ 'us-gov-east-1' => [], 'us-gov-west-1' => [], ], ],
				...
				'waf-regional'            => [ 'endpoints' => [ 'us-gov-west-1' => [], ], ],
				'workspaces'              => [ 'endpoints' => [ 'us-gov-west-1' => [], ], ],
			],
		],
	],
	'version'    => 3,
