...
return [
	...
	'shapes'     => [
		...
		'AcceptanceType'                          => [ 'type' => 'string', 'enum' => [ 'ACCEPT', 'REJECT', ], ],
		'Alias'                                   => [
			'type'    => 'structure',
			'members' => [
		...
		'BackfillMode'                            => [ 'type' => 'string', 'enum' => [ 'AUTOMATIC', 'MANUAL', ], ],
		...
		'DeleteMatchmakingRuleSetOutput'          => [ 'type' => 'structure', 'members' => [], ],
		...
		'DeleteScriptInput'                       => [
			'type'     => 'structure',
			'required' => [ 'ScriptId', ],
			'members'  => [ 'ScriptId' => [ 'shape' => 'ScriptId', ], ],
		],
		...
		'FleetAction'                             => [ 'type' => 'string', 'enum' => [ 'AUTO_SCALING', ], ],
		'FleetActionList'                         => [
			'type'   => 'list',
		...
		'GameSessionStatusReason'                 => [ 'type' => 'string', 'enum' => [ 'INTERRUPTED', ], ],
		...
		'InstanceStatus'                          => [
			'type' => 'string',
			'enum' => [ 'PENDING', 'ACTIVE', 'TERMINATING', ],
		],
		...
		'MatchmakerData'                          => [ 'type' => 'string', 'max' => 390000, 'min' => 1, ],
		...
		'OperatingSystem'                         => [
			'type' => 'string',
			'enum' => [ 'WINDOWS_2012', 'AMAZON_LINUX', ],
		],
		'PlacedPlayerSession'                     => [
			'type'    => 'structure',
			'members' => [
		...
		'PlayerList'                              => [ 'type' => 'list', 'member' => [ 'shape' => 'Player', ], ],
		'PlayerSession'                           => [
			'type'    => 'structure',
			'members' => [
				'PlayerSessionId' => [ 'shape' => 'PlayerSessionId', ],
		...
		'PlayerSessionStatus'                     => [
			'type' => 'string',
			'enum' => [ 'RESERVED', 'ACTIVE', 'COMPLETED', 'TIMEDOUT', ],
		],
		'PolicyType'                              => [ 'type' => 'string', 'enum' => [ 'RuleBased', 'TargetBased', ], ],
		'PortNumber'                              => [ 'type' => 'integer', 'max' => 60000, 'min' => 1, ],
		'PositiveInteger'                         => [ 'type' => 'integer', 'min' => 1, ],
		'PositiveLong'                            => [ 'type' => 'long', 'min' => 1, ],
		'ProtectionPolicy'                        => [
			'type' => 'string',
			'enum' => [ 'NoProtection', 'FullProtection', ],
		],
		...
		'RuleSetLimit'                            => [ 'type' => 'integer', 'max' => 10, 'min' => 1, ],
		...
		'ScriptList'                              => [ 'type' => 'list', 'member' => [ 'shape' => 'Script', ], ],
		...
		'StartFleetActionsOutput'                 => [ 'type' => 'structure', 'members' => [], ],
		...
		'StopFleetActionsOutput'                  => [ 'type' => 'structure', 'members' => [], ],
		...
		'TargetConfiguration'                     => [
			...
			'members'  => [ 'TargetValue' => [ 'shape' => 'Double', ], ],
		],
		...
		'ValidateMatchmakingRuleSetOutput'        => [
			'type'    => 'structure',
			'members' => [ 'Valid' => [ 'shape' => 'BooleanModel', ], ],
		],
