...
return [
	...
	'shapes'     => [
		...
		'GetScalingPlanResourceForecastDataResponse' => [
			'type'     => 'structure',
			'required' => [ 'Datapoints', ],
			'members'  => [ 'Datapoints' => [ 'shape' => 'Datapoints', ], ],
		],
		...
		'ScalingStatusCode'                          => [
			'type' => 'string',
			'enum' => [ 'Inactive', 'PartiallyActive', 'Active', ],
		],
		'ScheduledActionBufferTime'                  => [ 'type' => 'integer', 'min' => 0, ],
		'ServiceNamespace'                           => [
			'type' => 'string',
			'enum' => [ 'autoscaling', 'ecs', 'ec2', 'rds', 'dynamodb', ],
		],
		'TagFilter'                                  => [
			'type'    => 'structure',
			'members' => [
		...
		'UpdateScalingPlanResponse'                  => [ 'type' => 'structure', 'members' => [], ],
		'ValidationException'                        => [
			'type'      => 'structure',
			'members'   => [ 'Message' => [ 'shape' => 'ErrorMessage', ], ],
			'exception' => true,
