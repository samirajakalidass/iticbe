...
return [
	...
	'shapes'     => [
		...
		'BatchUpdateLinkAttributesResponse'    => [ 'type' => 'structure', 'members' => [], ],
		...
		'FacetAttributeType'                   => [
			'type' => 'string',
			'enum' => [ 'STRING', 'BINARY', 'BOOLEAN', 'NUMBER', 'DATETIME', ],
		],
		...
		'RequiredAttributeBehavior'            => [
			'type' => 'string',
			'enum' => [ 'REQUIRED_ALWAYS', 'NOT_REQUIRED', ],
		],
		'ResourceNotFoundException'            => [
			'type'      => 'structure',
			'members'   => [ 'Message' => [ 'shape' => 'ExceptionMessage', ], ],
		...
		'UpdateLinkAttributesResponse'         => [ 'type' => 'structure', 'members' => [], ],
