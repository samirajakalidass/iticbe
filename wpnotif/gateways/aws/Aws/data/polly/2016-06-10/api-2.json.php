...
return [
	...
	'shapes'     => [
		...
		'GetSpeechSynthesisTaskOutput'              => [
			'type'    => 'structure',
			'members' => [ 'SynthesisTask' => [ 'shape' => 'SynthesisTask', ], ],
		],
		...
		'NextToken'                                 => [ 'type' => 'string', 'max' => 4096, 'min' => 0, ],
		'OutputFormat'                              => [
			'type' => 'string',
		...
		'TaskId'                                    => [ 'type' => 'string', 'pattern' => '^[a-zA-Z0-9_-]{1,100}$', ],
		'TaskStatus'                                => [
			'type' => 'string',
			'enum' => [
				'scheduled',
