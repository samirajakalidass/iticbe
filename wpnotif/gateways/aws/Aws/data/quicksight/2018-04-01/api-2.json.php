...
return [
	...
	'shapes'     => [
		...
		'EmbeddingUrl'                             => [ 'type' => 'string', 'sensitive' => true, ],
		...
		'GroupDescription'                         => [ 'type' => 'string', 'max' => 512, 'min' => 1, ],
		...
		'GroupMemberList'                          => [ 'type' => 'list', 'member' => [ 'shape' => 'GroupMember', ], ],
		'GroupMemberName'                          => [
			'type'    => 'string',
			'max'     => 256,
			'min'     => 1,
		...
		'IdentityType'                             => [ 'type' => 'string', 'enum' => [ 'IAM', 'QUICKSIGHT', ], ],
		...
		'Namespace'                                => [ 'type' => 'string', 'pattern' => 'default', ],
		...
		'SessionLifetimeInMinutes'                 => [ 'type' => 'long', 'max' => 600, 'min' => 15, ],
