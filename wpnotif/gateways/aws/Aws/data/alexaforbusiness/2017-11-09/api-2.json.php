...
return [
	...
	'operations' => [
		...
		'AssociateSkillGroupWithRoom'        => [
			...
			'errors' => [ [ 'shape' => 'ConcurrentModificationException', ], ],
		],
		...
		'CreateBusinessReportSchedule'       => [
			...
			'errors' => [ [ 'shape' => 'AlreadyExistsException', ], ],
		],
		...
		'DeleteGatewayGroup'                 => [
			...
			'errors' => [ [ 'shape' => 'ResourceAssociatedException', ], ],
		],
		...
		'StartDeviceSync'                    => [
			...
			'errors' => [ [ 'shape' => 'DeviceNotRegisteredException', ], ],
		],
	...
	'shapes'     => [
		...
		'AmazonId'                                   => [ 'type' => 'string', 'pattern' => '[a-zA-Z0-9]{1,18}', ],
		...
		'ApproveSkillRequest'                        => [
			'type'     => 'structure',
			'required' => [ 'SkillId', ],
			'members'  => [ 'SkillId' => [ 'shape' => 'SkillId', ], ],
		],
		'ApproveSkillResponse'                       => [ 'type' => 'structure', 'members' => [], ],
		'Arn'                                        => [
			'type'    => 'string',
		...
		'AssociateContactWithAddressBookResponse'    => [ 'type' => 'structure', 'members' => [], ],
		...
		'AssociateDeviceWithNetworkProfileResponse'  => [ 'type' => 'structure', 'members' => [], ],
		...
		'AssociateSkillWithSkillGroupResponse'       => [ 'type' => 'structure', 'members' => [], ],
		'AssociateSkillWithUsersRequest'             => [
			'type'     => 'structure',
			'required' => [ 'SkillId', ],
			'members'  => [ 'SkillId' => [ 'shape' => 'SkillId', ], ],
		],
		'AssociateSkillWithUsersResponse'            => [ 'type' => 'structure', 'members' => [], ],
		'Audio'                                      => [
			'type'     => 'structure',
		...
		'BusinessReportContentRange'                 => [
			'type'    => 'structure',
			'members' => [ 'Interval' => [ 'shape' => 'BusinessReportInterval', ], ],
		],
		...
		'BusinessReportFormat'                       => [ 'type' => 'string', 'enum' => [ 'CSV', 'CSV_ZIP', ], ],
		'BusinessReportInterval'                     => [ 'type' => 'string', 'enum' => [ 'ONE_DAY', 'ONE_WEEK', ], ],
		'BusinessReportRecurrence'                   => [
			'type'    => 'structure',
			'members' => [ 'StartDate' => [ 'shape' => 'Date', ], ],
		],
		...
		'CommsProtocol'                              => [ 'type' => 'string', 'enum' => [ 'SIP', 'SIPS', 'H323', ], ],
		...
		'ConferencePreference'                       => [
			'type'    => 'structure',
			'members' => [ 'DefaultConferenceProviderArn' => [ 'shape' => 'Arn', ], ],
		],
		'ConferenceProvider'                         => [
			'type'    => 'structure',
			'members' => [
		...
		'CountryCode'                                => [ 'type' => 'string', 'pattern' => '\\d{1,3}', ],
		...
		'CreateAddressBookResponse'                  => [
			'type'    => 'structure',
			'members' => [ 'AddressBookArn' => [ 'shape' => 'Arn', ], ],
		],
		...
		'CreateConferenceProviderResponse'           => [
			'type'    => 'structure',
			'members' => [ 'ConferenceProviderArn' => [ 'shape' => 'Arn', ], ],
		],
		...
		'CreateGatewayGroupResponse'                 => [
			'type'    => 'structure',
			'members' => [ 'GatewayGroupArn' => [ 'shape' => 'Arn', ], ],
		],
		...
		'CreateNetworkProfileResponse'               => [
			'type'    => 'structure',
			'members' => [ 'NetworkProfileArn' => [ 'shape' => 'Arn', ], ],
		],
		...
		'CreateSkillGroupResponse'                   => [
			'type'    => 'structure',
			'members' => [ 'SkillGroupArn' => [ 'shape' => 'Arn', ], ],
		],
		'CreateUserRequest'                          => [
			'type'     => 'structure',
			'required' => [ 'UserId', ],
		...
		'CustomerS3BucketName'                       => [ 'type' => 'string', 'pattern' => '[a-z0-9-\\.]{3,63}', ],
		'Date'                                       => [
			'type'    => 'string',
		...
		'DeleteAddressBookResponse'                  => [ 'type' => 'structure', 'members' => [], ],
		'DeleteBusinessReportScheduleRequest'        => [
			'type'     => 'structure',
			'required' => [ 'ScheduleArn', ],
			'members'  => [ 'ScheduleArn' => [ 'shape' => 'Arn', ], ],
		],
		'DeleteBusinessReportScheduleResponse'       => [ 'type' => 'structure', 'members' => [], ],
		'DeleteConferenceProviderRequest'            => [
			'type'     => 'structure',
			'required' => [ 'ConferenceProviderArn', ],
			'members'  => [ 'ConferenceProviderArn' => [ 'shape' => 'Arn', ], ],
		],
		'DeleteConferenceProviderResponse'           => [ 'type' => 'structure', 'members' => [], ],
		'DeleteContactRequest'                       => [
			'type'     => 'structure',
			'required' => [ 'ContactArn', ],
			'members'  => [ 'ContactArn' => [ 'shape' => 'Arn', ], ],
		],
		'DeleteContactResponse'                      => [ 'type' => 'structure', 'members' => [], ],
		'DeleteDeviceRequest'                        => [
			'type'     => 'structure',
			'required' => [ 'DeviceArn', ],
			'members'  => [ 'DeviceArn' => [ 'shape' => 'Arn', ], ],
		],
		'DeleteDeviceResponse'                       => [ 'type' => 'structure', 'members' => [], ],
		...
		'DeleteDeviceUsageDataResponse'              => [ 'type' => 'structure', 'members' => [], ],
		'DeleteGatewayGroupRequest'                  => [
			'type'     => 'structure',
			'required' => [ 'GatewayGroupArn', ],
			'members'  => [ 'GatewayGroupArn' => [ 'shape' => 'Arn', ], ],
		],
		'DeleteGatewayGroupResponse'                 => [ 'type' => 'structure', 'members' => [], ],
		'DeleteNetworkProfileRequest'                => [
			'type'     => 'structure',
			'required' => [ 'NetworkProfileArn', ],
			'members'  => [ 'NetworkProfileArn' => [ 'shape' => 'Arn', ], ],
		],
		'DeleteNetworkProfileResponse'               => [ 'type' => 'structure', 'members' => [], ],
		...
		'DeleteSkillAuthorizationResponse'           => [ 'type' => 'structure', 'members' => [], ],
		...
		'DeviceEventType'                            => [
			'type' => 'string',
			'enum' => [ 'CONNECTION_STATUS', 'DEVICE_STATUS', ],
		],
		...
		'DeviceSerialNumberForAVS'                   => [ 'type' => 'string', 'pattern' => '^[a-zA-Z0-9]{1,50}$', ],
		'DeviceStatus'                               => [
			'type' => 'string',
			'enum' => [
				'READY',
		...
		'DeviceUsageType'                            => [ 'type' => 'string', 'enum' => [ 'VOICE', ], ],
		...
		'DisassociateContactFromAddressBookResponse' => [ 'type' => 'structure', 'members' => [], ],
		...
		'DisassociateSkillFromSkillGroupResponse'    => [ 'type' => 'structure', 'members' => [], ],
		'DisassociateSkillFromUsersRequest'          => [
			'type'     => 'structure',
			'required' => [ 'SkillId', ],
			'members'  => [ 'SkillId' => [ 'shape' => 'SkillId', ], ],
		],
		'DisassociateSkillFromUsersResponse'         => [ 'type' => 'structure', 'members' => [], ],
		...
		'EnablementType'                             => [ 'type' => 'string', 'enum' => [ 'ENABLED', 'PENDING', ], ],
		'EnablementTypeFilter'                       => [ 'type' => 'string', 'enum' => [ 'ENABLED', 'PENDING', ], ],
		'EndUserLicenseAgreement'                    => [ 'type' => 'string', ],
		'Endpoint'                                   => [ 'type' => 'string', 'max' => 256, 'min' => 1, ],
		...
		'ForgetSmartHomeAppliancesResponse'          => [ 'type' => 'structure', 'members' => [], ],
		'Gateway'                                    => [
			'type'    => 'structure',
			'members' => [
				'Arn'             => [ 'shape' => 'Arn', ],
		...
		'GatewayGroupDescription'                    => [ 'type' => 'string', 'max' => 200, 'min' => 0, ],
		'GatewayGroupName'                           => [
			'type'    => 'string',
			'max'     => 100,
			'min'     => 1,
		...
		'GatewayVersion'                             => [ 'type' => 'string', 'max' => 50, 'min' => 1, ],
		...
		'GetAddressBookResponse'                     => [
			'type'    => 'structure',
			'members' => [ 'AddressBook' => [ 'shape' => 'AddressBook', ], ],
		],
		'GetConferencePreferenceRequest'             => [ 'type' => 'structure', 'members' => [], ],
		'GetConferencePreferenceResponse'            => [
			'type'    => 'structure',
			'members' => [ 'Preference' => [ 'shape' => 'ConferencePreference', ], ],
		],
		...
		'GetConferenceProviderResponse'              => [
			'type'    => 'structure',
			'members' => [ 'ConferenceProvider' => [ 'shape' => 'ConferenceProvider', ], ],
		],
		'GetContactRequest'                          => [
			'type'     => 'structure',
			'required' => [ 'ContactArn', ],
		...
		'GetGatewayGroupResponse'                    => [
			'type'    => 'structure',
			'members' => [ 'GatewayGroup' => [ 'shape' => 'GatewayGroup', ], ],
		],
		'GetGatewayRequest'                          => [
			'type'     => 'structure',
			'required' => [ 'GatewayArn', ],
			'members'  => [ 'GatewayArn' => [ 'shape' => 'Arn', ], ],
		],
		'GetGatewayResponse'                         => [
			'type'    => 'structure',
			'members' => [ 'Gateway' => [ 'shape' => 'Gateway', ], ],
		],
		'GetInvitationConfigurationRequest'          => [ 'type' => 'structure', 'members' => [], ],
		...
		'GetSkillGroupResponse'                      => [
			'type'    => 'structure',
			'members' => [ 'SkillGroup' => [ 'shape' => 'SkillGroup', ], ],
		],
		'IPDialIn'                                   => [
			'type'     => 'structure',
		...
		'MeetingSetting'                             => [
			'type'     => 'structure',
			'required' => [ 'RequirePin', ],
			'members'  => [ 'RequirePin' => [ 'shape' => 'RequirePin', ], ],
		],
		'NameInUseException'                         => [
			'type'      => 'structure',
			'members'   => [ 'Message' => [ 'shape' => 'ErrorMessage', ], ],
		...
		'NetworkEapMethod'                           => [ 'type' => 'string', 'enum' => [ 'EAP_TLS', ], ],
		'NetworkProfile'                             => [
			'type'    => 'structure',
			'members' => [
				'NetworkProfileArn'       => [ 'shape' => 'Arn', ],
		...
		'NextToken'                                  => [ 'type' => 'string', 'max' => 1100, 'min' => 1, ],
		'NextWiFiPassword'                           => [
			'type'      => 'string',
			'max'       => 128,
			'min'       => 0,
		...
		'OneClickIdDelay'                            => [ 'type' => 'string', 'max' => 2, 'min' => 1, ],
		'OneClickPinDelay'                           => [ 'type' => 'string', 'max' => 2, 'min' => 1, ],
		'OrganizationName'                           => [
			'type'    => 'string',
			'max'     => 100,
			'min'     => 1,
		...
		'OutboundPhoneNumber'                        => [ 'type' => 'string', 'pattern' => '\\d{10}', ],
		'PSTNDialIn'                                 => [
			'type'     => 'structure',
			'required' => [
				'CountryCode',
		...
		'ProductId'                                  => [ 'type' => 'string', 'pattern' => '^[a-zA-Z0-9_]{1,256}$', ],
		'Profile'                                    => [
			'type'    => 'structure',
			'members' => [
				'ProfileArn'        => [ 'shape' => 'Arn', ],
		...
		'PutConferencePreferenceRequest'             => [
			...
			'members'  => [ 'ConferencePreference' => [ 'shape' => 'ConferencePreference', ], ],
		],
		'PutConferencePreferenceResponse'            => [ 'type' => 'structure', 'members' => [], ],
		...
		'PutInvitationConfigurationResponse'         => [ 'type' => 'structure', 'members' => [], ],
		...
		'PutSkillAuthorizationResponse'              => [ 'type' => 'structure', 'members' => [], ],
		'RawPhoneNumber'                             => [
			'type'      => 'string',
			'max'       => 50,
			'min'       => 0,
		...
		'RejectSkillResponse'                        => [ 'type' => 'structure', 'members' => [], ],
		'ReleaseDate'                                => [ 'type' => 'string', ],
		'RequirePin'                                 => [ 'type' => 'string', 'enum' => [ 'YES', 'NO', 'OPTIONAL', ], ],
		'ResolveRoomRequest'                         => [
			'type'     => 'structure',
		...
		'RevokeInvitationResponse'                   => [ 'type' => 'structure', 'members' => [], ],
		'Room'                                       => [
			'type'    => 'structure',
			'members' => [
				'RoomArn'            => [ 'shape' => 'Arn', ],
		...
		'SampleUtterances'                           => [ 'type' => 'list', 'member' => [ 'shape' => 'Utterance', ], ],
		...
		'SendAnnouncementResponse'                   => [
			'type'    => 'structure',
			'members' => [ 'AnnouncementArn' => [ 'shape' => 'Arn', ], ],
		],
		'SendInvitationRequest'                      => [
			'type'    => 'structure',
			'members' => [ 'UserArn' => [ 'shape' => 'Arn', ], ],
		],
		'SendInvitationResponse'                     => [ 'type' => 'structure', 'members' => [], ],
		...
		'StartDeviceSyncResponse'                    => [ 'type' => 'structure', 'members' => [], ],
		'StartSmartHomeApplianceDiscoveryRequest'    => [
			'type'     => 'structure',
			'required' => [ 'RoomArn', ],
			'members'  => [ 'RoomArn' => [ 'shape' => 'Arn', ], ],
		],
		'StartSmartHomeApplianceDiscoveryResponse'   => [ 'type' => 'structure', 'members' => [], ],
		'Tag'                                        => [
			'type'     => 'structure',
			'required' => [ 'Key', 'Value', ],
			'members'  => [
		...
		'TimeToLiveInSeconds'                        => [ 'type' => 'integer', 'max' => 3600, 'min' => 1, ],
		'Timezone'                                   => [ 'type' => 'string', 'max' => 100, 'min' => 1, ],
		...
		'UpdateAddressBookResponse'                  => [ 'type' => 'structure', 'members' => [], ],
		...
		'UpdateBusinessReportScheduleResponse'       => [ 'type' => 'structure', 'members' => [], ],
		...
		'UpdateConferenceProviderResponse'           => [ 'type' => 'structure', 'members' => [], ],
		...
		'UpdateContactResponse'                      => [ 'type' => 'structure', 'members' => [], ],
		'UpdateDeviceRequest'                        => [
			'type'    => 'structure',
			'members' => [
				'DeviceArn'  => [ 'shape' => 'Arn', ],
		...
		'UpdateGatewayGroupResponse'                 => [ 'type' => 'structure', 'members' => [], ],
		...
		'UpdateGatewayResponse'                      => [ 'type' => 'structure', 'members' => [], ],
		...
		'UpdateNetworkProfileResponse'               => [ 'type' => 'structure', 'members' => [], ],
		...
		'UpdateProfileResponse'                      => [ 'type' => 'structure', 'members' => [], ],
		'UpdateRoomRequest'                          => [
			'type'    => 'structure',
			'members' => [
				'RoomArn'            => [ 'shape' => 'Arn', ],
		...
		'UpdateSkillGroupResponse'                   => [ 'type' => 'structure', 'members' => [], ],
		'Url'                                        => [ 'type' => 'string', ],
		'UserCode'                                   => [ 'type' => 'string', 'max' => 128, 'min' => 1, ],
		'UserData'                                   => [
			'type'    => 'structure',
			'members' => [
				'UserArn'          => [ 'shape' => 'Arn', ],
		...
		'WakeWord'                                   => [
			'type' => 'string',
			'enum' => [ 'ALEXA', 'AMAZON', 'ECHO', 'COMPUTER', ],
		],
		'boolean'                                    => [ 'type' => 'boolean', ],
		'user_FirstName'                             => [
			'type'    => 'string',
