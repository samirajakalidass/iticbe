...
return [
	...
	'shapes'     => [
		'AccessDeniedException'                    => [
			'type'      => 'structure',
			'members'   => [ 'Message' => [ 'shape' => 'MessageString', ], ],
			'exception' => true,
		],
		'Action'                                   => [
			'type'    => 'structure',
		...
		'BatchDeleteTableResponse'                 => [
			'type'    => 'structure',
			'members' => [ 'Errors' => [ 'shape' => 'TableErrors', ], ],
		],
		...
		'BatchGetCrawlersRequest'                  => [
			...
			'members'  => [ 'CrawlerNames' => [ 'shape' => 'CrawlerNameList', ], ],
		],
		...
		'BatchGetDevEndpointsRequest'              => [
			...
			'members'  => [ 'DevEndpointNames' => [ 'shape' => 'DevEndpointNames', ], ],
		],
		...
		'BatchGetJobsRequest'                      => [
			'type'     => 'structure',
			'required' => [ 'JobNames', ],
			'members'  => [ 'JobNames' => [ 'shape' => 'JobNameList', ], ],
		],
		...
		'BatchGetTriggersRequest'                  => [
			...
			'members'  => [ 'TriggerNames' => [ 'shape' => 'TriggerNameList', ], ],
		],
		...
		'CatalogEncryptionMode'                    => [ 'type' => 'string', 'enum' => [ 'DISABLED', 'SSE-KMS', ], ],
		'CatalogEntries'                           => [ 'type' => 'list', 'member' => [ 'shape' => 'CatalogEntry', ], ],
		'CatalogEntry'                             => [
			'type'     => 'structure',
		...
		'CloudWatchEncryptionMode'                 => [ 'type' => 'string', 'enum' => [ 'DISABLED', 'SSE-KMS', ], ],
		...
		'ConnectionsList'                          => [
			'type'    => 'structure',
			'members' => [ 'Connections' => [ 'shape' => 'OrchestrationStringList', ], ],
		],
		'Crawl'                                    => [
			'type'    => 'structure',
			'members' => [
		...
		'CrawlList'                                => [ 'type' => 'list', 'member' => [ 'shape' => 'Crawl', ], ],
		'CrawlState'                               => [
			'type' => 'string',
		...
		'CrawlerNodeDetails'                       => [
			'type'    => 'structure',
			'members' => [ 'Crawls' => [ 'shape' => 'CrawlList', ], ],
		],
		...
		'CrawlerSecurityConfiguration'             => [ 'type' => 'string', 'max' => 128, 'min' => 0, ],
		'CrawlerState'                             => [
			'type' => 'string',
			'enum' => [ 'READY', 'RUNNING', 'STOPPING', ],
		],
		...
		'CsvHeader'                                => [ 'type' => 'list', 'member' => [ 'shape' => 'NameString', ], ],
		'CsvHeaderOption'                          => [
			'type' => 'string',
		...
		'DeleteResourcePolicyRequest'              => [
			'type'    => 'structure',
			'members' => [ 'PolicyHashCondition' => [ 'shape' => 'HashString', ], ],
		],
		'DeleteResourcePolicyResponse'             => [ 'type' => 'structure', 'members' => [], ],
		'DeleteSecurityConfigurationRequest'       => [
			'type'     => 'structure',
			'required' => [ 'Name', ],
			'members'  => [ 'Name' => [ 'shape' => 'NameString', ], ],
		],
		'DeleteSecurityConfigurationResponse'      => [ 'type' => 'structure', 'members' => [], ],
		'DeleteTableRequest'                       => [
			'type'     => 'structure',
		...
		'DevEndpointNameList'                      => [ 'type' => 'list', 'member' => [ 'shape' => 'NameString', ], ],
		'DevEndpointNames'                         => [
			'type'   => 'list',
		...
		'ExistCondition'                           => [
			'type' => 'string',
			'enum' => [ 'MUST_EXIST', 'NOT_EXIST', 'NONE', ],
		],
		...
		'GetClassifierResponse'                    => [
			'type'    => 'structure',
			'members' => [ 'Classifier' => [ 'shape' => 'Classifier', ], ],
		],
		...
		'GetDataCatalogEncryptionSettingsResponse' => [
			'type'    => 'structure',
			'members' => [ 'DataCatalogEncryptionSettings' => [ 'shape' => 'DataCatalogEncryptionSettings', ], ],
		],
		'GetDatabaseRequest'                       => [
			'type'     => 'structure',
			'required' => [ 'Name', ],
		...
		'GetDatabaseResponse'                      => [
			'type'    => 'structure',
			'members' => [ 'Database' => [ 'shape' => 'Database', ], ],
		],
		'GetDatabasesRequest'                      => [
			'type'    => 'structure',
			'members' => [
		...
		'GetDevEndpointResponse'                   => [
			'type'    => 'structure',
			'members' => [ 'DevEndpoint' => [ 'shape' => 'DevEndpoint', ], ],
		],
		...
		'GetPartitionResponse'                     => [
			'type'    => 'structure',
			'members' => [ 'Partition' => [ 'shape' => 'Partition', ], ],
		],
		...
		'GetResourcePolicyRequest'                 => [ 'type' => 'structure', 'members' => [], ],
		...
		'GetSecurityConfigurationResponse'         => [
			'type'    => 'structure',
			'members' => [ 'SecurityConfiguration' => [ 'shape' => 'SecurityConfiguration', ], ],
		],
		...
		'GetTagsRequest'                           => [
			...
			'members'  => [ 'ResourceArn' => [ 'shape' => 'GlueResourceArn', ], ],
		],
		'GetTagsResponse'                          => [
			'type'    => 'structure',
		...
		'GetWorkflowResponse'                      => [
			'type'    => 'structure',
			'members' => [ 'Workflow' => [ 'shape' => 'Workflow', ], ],
		],
		...
		'GetWorkflowRunPropertiesResponse'         => [
			'type'    => 'structure',
			'members' => [ 'RunProperties' => [ 'shape' => 'WorkflowRunProperties', ], ],
		],
		...
		'ImportCatalogToGlueResponse'              => [ 'type' => 'structure', 'members' => [], ],
		'Integer'                                  => [ 'type' => 'integer', ],
		'IntegerFlag'                              => [ 'type' => 'integer', 'max' => 1, 'min' => 0, ],
		...
		'JdbcTargetList'                           => [ 'type' => 'list', 'member' => [ 'shape' => 'JdbcTarget', ], ],
		'Job'                                      => [
			'type'    => 'structure',
			'members' => [
				'Name'                  => [ 'shape' => 'NameString', ],
		...
		'JobBookmarksEncryptionMode'               => [ 'type' => 'string', 'enum' => [ 'DISABLED', 'CSE-KMS', ], ],
		'JobCommand'                               => [
			'type'    => 'structure',
			'members' => [
		...
		'JobName'                                  => [ 'type' => 'string', ],
		'JobNameList'                              => [ 'type' => 'list', 'member' => [ 'shape' => 'NameString', ], ],
		'JobNodeDetails'                           => [
			'type'    => 'structure',
			'members' => [ 'JobRuns' => [ 'shape' => 'JobRunList', ], ],
		],
		'JobRun'                                   => [
			'type'    => 'structure',
			'members' => [
		...
		'JobRunList'                               => [ 'type' => 'list', 'member' => [ 'shape' => 'JobRun', ], ],
		'JobRunState'                              => [
			'type' => 'string',
			'enum' => [
				'STARTING',
		...
		'KmsKeyArn'                                => [ 'type' => 'string', 'pattern' => 'arn:aws:kms:.*', ],
		'Language'                                 => [ 'type' => 'string', 'enum' => [ 'PYTHON', 'SCALA', ], ],
		'LastCrawlInfo'                            => [
			'type'    => 'structure',
			'members' => [
		...
		'NodeType'                                 => [
			'type' => 'string',
			'enum' => [ 'CRAWLER', 'JOB', 'TRIGGER', ],
		],
		'NonNegativeDouble'                        => [ 'type' => 'double', 'min' => 0, ],
		'NonNegativeInteger'                       => [ 'type' => 'integer', 'min' => 0, ],
		'NotificationProperty'                     => [
			'type'    => 'structure',
			'members' => [ 'NotifyDelayAfter' => [ 'shape' => 'NotifyDelayAfter', ], ],
		],
		'NotifyDelayAfter'                         => [ 'type' => 'integer', 'box' => true, 'min' => 1, ],
		'NullableBoolean'                          => [ 'type' => 'boolean', 'box' => true, ],
		'NullableDouble'                           => [ 'type' => 'double', 'box' => true, ],
		'NullableInteger'                          => [ 'type' => 'integer', 'box' => true, ],
		...
		'ParametersMapValue'                       => [ 'type' => 'string', 'max' => 512000, ],
		'Partition'                                => [
			'type'    => 'structure',
			'members' => [
		...
		'PartitionValueList'                       => [
			'type'     => 'structure',
			'required' => [ 'Values', ],
			'members'  => [ 'Values' => [ 'shape' => 'ValueStringList', ], ],
		],
		'Path'                                     => [ 'type' => 'string', ],
		...
		'PolicyJsonString'                         => [ 'type' => 'string', 'max' => 10240, 'min' => 2, ],
		'Predecessor'                              => [
			'type'    => 'structure',
			'members' => [
				'JobName' => [ 'shape' => 'NameString', ],
		...
		'PutDataCatalogEncryptionSettingsResponse' => [ 'type' => 'structure', 'members' => [], ],
		...
		'PutResourcePolicyResponse'                => [
			'type'    => 'structure',
			'members' => [ 'PolicyHash' => [ 'shape' => 'HashString', ], ],
		],
		...
		'PutWorkflowRunPropertiesResponse'         => [ 'type' => 'structure', 'members' => [], ],
		'PythonScript'                             => [ 'type' => 'string', ],
		'PythonVersionString'                      => [ 'type' => 'string', 'pattern' => '^[2-3]$', ],
		...
		'S3EncryptionList'                         => [ 'type' => 'list', 'member' => [ 'shape' => 'S3Encryption', ], ],
		'S3EncryptionMode'                         => [
			'type' => 'string',
			'enum' => [ 'DISABLED', 'SSE-KMS', 'SSE-S3', ],
		],
		'S3Target'                                 => [
			'type'    => 'structure',
			'members' => [
		...
		'S3TargetList'                             => [ 'type' => 'list', 'member' => [ 'shape' => 'S3Target', ], ],
		...
		'ScheduleState'                            => [
			'type' => 'string',
			'enum' => [ 'SCHEDULED', 'NOT_SCHEDULED', 'TRANSITIONING', ],
		],
		...
		'StartJobRunResponse'                      => [
			'type'    => 'structure',
			'members' => [ 'JobRunId' => [ 'shape' => 'IdString', ], ],
		],
		'StartTriggerRequest'                      => [
			'type'     => 'structure',
			'required' => [ 'Name', ],
		...
		'TableList'                                => [ 'type' => 'list', 'member' => [ 'shape' => 'Table', ], ],
		'TableName'                                => [ 'type' => 'string', ],
		'TablePrefix'                              => [ 'type' => 'string', 'max' => 128, 'min' => 0, ],
		'TableTypeString'                          => [ 'type' => 'string', 'max' => 255, ],
		'TableVersion'                             => [
			'type'    => 'structure',
			'members' => [
				'Table'     => [ 'shape' => 'Table', ],
		...
		'Timeout'                                  => [ 'type' => 'integer', 'box' => true, 'min' => 1, ],
		'Timestamp'                                => [ 'type' => 'timestamp', ],
		'TimestampValue'                           => [ 'type' => 'timestamp', ],
		'Token'                                    => [ 'type' => 'string', ],
		'TotalSegmentsInteger'                     => [ 'type' => 'integer', 'max' => 10, 'min' => 1, ],
		'Trigger'                                  => [
			'type'    => 'structure',
			'members' => [
				'Name'         => [ 'shape' => 'NameString', ],
		...
		'TriggerNameList'                          => [ 'type' => 'list', 'member' => [ 'shape' => 'NameString', ], ],
		'TriggerNodeDetails'                       => [
			'type'    => 'structure',
			'members' => [ 'Trigger' => [ 'shape' => 'Trigger', ], ],
		],
		...
		'TriggerType'                              => [
			'type' => 'string',
			'enum' => [ 'SCHEDULED', 'CONDITIONAL', 'ON_DEMAND', ],
		],
		'TriggerUpdate'                            => [
			'type'    => 'structure',
			'members' => [
		...
		'ValueString'                              => [ 'type' => 'string', 'max' => 1024, ],
