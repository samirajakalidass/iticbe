...
return [
	...
	'shapes'     => [
		'AutomaticallyRotateAfterDaysType' => [ 'type' => 'long', 'max' => 1000, 'min' => 1, ],
		...
		'ClientRequestTokenType'           => [ 'type' => 'string', 'max' => 64, 'min' => 32, ],
		'CreateSecretRequest'              => [
			'type'     => 'structure',
			'required' => [ 'Name', ],
			'members'  => [
		...
		'ExcludeCharactersType'            => [ 'type' => 'string', 'max' => 4096, 'min' => 0, ],
		...
		'GetRandomPasswordResponse'        => [
			'type'    => 'structure',
			'members' => [ 'RandomPassword' => [ 'shape' => 'RandomPasswordType', ], ],
		],
		...
		'KmsKeyIdType'                     => [ 'type' => 'string', 'max' => 2048, 'min' => 0, ],
		...
		'MaxResultsType'                   => [ 'type' => 'integer', 'max' => 100, 'min' => 1, ],
		'NameType'                         => [ 'type' => 'string', 'max' => 512, 'min' => 1, ],
		'NextTokenType'                    => [ 'type' => 'string', 'max' => 4096, 'min' => 1, ],
		'NonEmptyResourcePolicyType'       => [ 'type' => 'string', 'max' => 4096, 'min' => 1, ],
		'PasswordLengthType'               => [ 'type' => 'long', 'max' => 4096, 'min' => 1, ],
		...
		'RandomPasswordType'               => [ 'type' => 'string', 'max' => 4096, 'min' => 0, ],
		...
		'RotationLambdaARNType'            => [ 'type' => 'string', 'max' => 2048, 'min' => 0, ],
		'RotationRulesType'                => [
			'type'    => 'structure',
			'members' => [
		...
		'SecretARNType'                    => [ 'type' => 'string', 'max' => 2048, 'min' => 20, ],
		'SecretBinaryType'                 => [ 'type' => 'blob', 'max' => 7168, 'min' => 0, 'sensitive' => true, ],
		'SecretIdType'                     => [ 'type' => 'string', 'max' => 2048, 'min' => 1, ],
		'SecretListEntry'                  => [
			'type'    => 'structure',
			'members' => [
				'ARN'                    => [ 'shape' => 'SecretARNType', ],
		...
		'SecretNameType'                   => [ 'type' => 'string', 'max' => 256, 'min' => 1, ],
		'SecretStringType'                 => [ 'type' => 'string', 'max' => 7168, 'min' => 0, 'sensitive' => true, ],
		'SecretVersionIdType'              => [ 'type' => 'string', 'max' => 64, 'min' => 32, ],
		'SecretVersionStageType'           => [ 'type' => 'string', 'max' => 256, 'min' => 1, ],
		...
		'TagKeyListType'                   => [ 'type' => 'list', 'member' => [ 'shape' => 'TagKeyType', ], ],
