...
return [
	...
	'shapes'     => [
		...
		'AutoMLResult'                           => [
			'type'    => 'structure',
			'members' => [ 'bestRecipeArn' => [ 'shape' => 'Arn', ], ],
		],
		'AvroSchema'                             => [ 'type' => 'string', 'max' => 10000, ],
		'Campaign'                               => [
			'type'    => 'structure',
			'members' => [
				'name'                 => [ 'shape' => 'Name', ],
		...
		'CategoricalValue'                       => [ 'type' => 'string', 'max' => 1000, ],
		'CategoricalValues'                      => [
			'type'   => 'list',
		...
		'ContinuousMaxValue'                     => [ 'type' => 'double', 'min' => - 1000000, ],
		'ContinuousMinValue'                     => [ 'type' => 'double', 'min' => - 1000000, ],
		...
		'CreateDatasetGroupResponse'             => [
			'type'    => 'structure',
			'members' => [ 'datasetGroupArn' => [ 'shape' => 'Arn', ], ],
		],
		...
		'CreateDatasetImportJobResponse'         => [
			'type'    => 'structure',
			'members' => [ 'datasetImportJobArn' => [ 'shape' => 'Arn', ], ],
		],
		...
		'CreateSolutionVersionResponse'          => [
			'type'    => 'structure',
			'members' => [ 'solutionVersionArn' => [ 'shape' => 'Arn', ], ],
		],
		'DataSource'                             => [
			'type'    => 'structure',
			'members' => [ 'dataLocation' => [ 'shape' => 'S3Location', ], ],
		],
		'Dataset'                                => [
			'type'    => 'structure',
			'members' => [
		...
		'DatasetType'                            => [ 'type' => 'string', 'max' => 256, ],
		'Datasets'                               => [
			'type'   => 'list',
		...
		'DeleteEventTrackerRequest'              => [
			...
			'members'  => [ 'eventTrackerArn' => [ 'shape' => 'Arn', ], ],
		],
		'DeleteSchemaRequest'                    => [
			'type'     => 'structure',
			'required' => [ 'schemaArn', ],
		...
		'DescribeAlgorithmRequest'               => [
			...
			'members'  => [ 'algorithmArn' => [ 'shape' => 'Arn', ], ],
		],
		'DescribeAlgorithmResponse'              => [
			'type'    => 'structure',
			'members' => [ 'algorithm' => [ 'shape' => 'Algorithm', ], ],
		],
		...
		'DescribeCampaignResponse'               => [
			'type'    => 'structure',
			'members' => [ 'campaign' => [ 'shape' => 'Campaign', ], ],
		],
		...
		'DescribeDatasetGroupResponse'           => [
			'type'    => 'structure',
			'members' => [ 'datasetGroup' => [ 'shape' => 'DatasetGroup', ], ],
		],
		...
		'DescribeDatasetImportJobResponse'       => [
			'type'    => 'structure',
			'members' => [ 'datasetImportJob' => [ 'shape' => 'DatasetImportJob', ], ],
		],
		...
		'DescribeEventTrackerResponse'           => [
			'type'    => 'structure',
			'members' => [ 'eventTracker' => [ 'shape' => 'EventTracker', ], ],
		],
		'DescribeFeatureTransformationRequest'   => [
			'type'     => 'structure',
			'required' => [ 'featureTransformationArn', ],
			'members'  => [ 'featureTransformationArn' => [ 'shape' => 'Arn', ], ],
		],
		'DescribeFeatureTransformationResponse'  => [
			'type'    => 'structure',
			'members' => [ 'featureTransformation' => [ 'shape' => 'FeatureTransformation', ], ],
		],
		'DescribeRecipeRequest'                  => [
			'type'     => 'structure',
			'required' => [ 'recipeArn', ],
			'members'  => [ 'recipeArn' => [ 'shape' => 'Arn', ], ],
		],
		'DescribeRecipeResponse'                 => [
			'type'    => 'structure',
			'members' => [ 'recipe' => [ 'shape' => 'Recipe', ], ],
		],
		...
		'DescribeSchemaResponse'                 => [
			'type'    => 'structure',
			'members' => [ 'schema' => [ 'shape' => 'DatasetSchema', ], ],
		],
		...
		'DescribeSolutionResponse'               => [
			'type'    => 'structure',
			'members' => [ 'solution' => [ 'shape' => 'Solution', ], ],
		],
		...
		'DescribeSolutionVersionResponse'        => [
			'type'    => 'structure',
			'members' => [ 'solutionVersion' => [ 'shape' => 'SolutionVersion', ], ],
		],
		'Description'                            => [ 'type' => 'string', ],
		'DockerURI'                              => [ 'type' => 'string', 'max' => 256, ],
		...
		'EventType'                              => [ 'type' => 'string', 'max' => 256, ],
		'EventValueThreshold'                    => [ 'type' => 'string', 'max' => 256, ],
		...
		'HPOObjectiveType'                       => [ 'type' => 'string', 'max' => 256, ],
		'HPOResource'                            => [ 'type' => 'string', 'max' => 256, ],
		'HPOResourceConfig'                      => [
			'type'    => 'structure',
			'members' => [
		...
		'IntegerMaxValue'                        => [ 'type' => 'integer', 'max' => 1000000, ],
		'IntegerMinValue'                        => [ 'type' => 'integer', 'min' => - 1000000, ],
		...
		'MetricName'                             => [ 'type' => 'string', 'max' => 256, ],
		'MetricRegex'                            => [ 'type' => 'string', 'max' => 256, ],
		...
		'NextToken'                              => [ 'type' => 'string', 'max' => 1300, ],
		'ParameterName'                          => [ 'type' => 'string', 'max' => 256, ],
		'ParameterValue'                         => [ 'type' => 'string', 'max' => 1000, ],
		...
		'RecipeProvider'                         => [ 'type' => 'string', 'enum' => [ 'SERVICE', ], ],
		'RecipeSummary'                          => [
			'type'    => 'structure',
			'members' => [
				'name'                => [ 'shape' => 'Name', ],
		...
		'RecipeType'                             => [ 'type' => 'string', 'max' => 256, ],
		'Recipes'                                => [
			'type'   => 'list',
		...
		'S3Location'                             => [ 'type' => 'string', 'max' => 256, ],
		'Schemas'                                => [
			'type'   => 'list',
		...
		'Status'                                 => [ 'type' => 'string', 'max' => 256, ],
		'TrackingId'                             => [ 'type' => 'string', 'max' => 256, ],
		'TrainingInputMode'                      => [ 'type' => 'string', 'max' => 256, ],
		'TransactionsPerSecond'                  => [ 'type' => 'integer', 'min' => 1, ],
