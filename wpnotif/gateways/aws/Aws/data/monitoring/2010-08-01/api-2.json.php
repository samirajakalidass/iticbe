...
return [
	...
	'shapes'     => [
		...
		'AmazonResourceName'                   => [ 'type' => 'string', 'max' => 1024, 'min' => 1, ],
		'AnomalyDetector'                      => [
			'type'    => 'structure',
			'members' => [
		...
		'AnomalyDetectorExcludedTimeRanges'    => [ 'type' => 'list', 'member' => [ 'shape' => 'Range', ], ],
		'AnomalyDetectorMetricTimezone'        => [ 'type' => 'string', ],
		'AnomalyDetectors'                     => [ 'type' => 'list', 'member' => [ 'shape' => 'AnomalyDetector', ], ],
		...
		'Counts'                               => [ 'type' => 'list', 'member' => [ 'shape' => 'DatapointValue', ], ],
		...
		'DatapointValues'                      => [ 'type' => 'list', 'member' => [ 'shape' => 'DatapointValue', ], ],
		...
		'DeleteAnomalyDetectorOutput'          => [ 'type' => 'structure', 'members' => [], ],
		...
		'GetMetricWidgetImageOutput'           => [
			'type'    => 'structure',
			'members' => [ 'MetricWidgetImage' => [ 'shape' => 'MetricWidgetImage', ], ],
		],
		...
		'MaxReturnedResultsCount'              => [ 'type' => 'integer', 'min' => 1, ],
		'Message'                              => [ 'type' => 'string', ],
		'MessageData'                          => [
			'type'    => 'structure',
			'members' => [
		...
		'MetricDataQueries'                    => [ 'type' => 'list', 'member' => [ 'shape' => 'MetricDataQuery', ], ],
		'MetricDataQuery'                      => [
			'type'     => 'structure',
			'required' => [ 'Id', ],
			'members'  => [
		...
		'MetricDataResultMessages'             => [ 'type' => 'list', 'member' => [ 'shape' => 'MessageData', ], ],
		'MetricDataResults'                    => [ 'type' => 'list', 'member' => [ 'shape' => 'MetricDataResult', ], ],
		'MetricDatum'                          => [
			'type'     => 'structure',
			'required' => [ 'MetricName', ],
			'members'  => [
		...
		'MetricExpression'                     => [ 'type' => 'string', 'max' => 1024, 'min' => 1, ],
		'MetricId'                             => [ 'type' => 'string', 'max' => 255, 'min' => 1, ],
		...
		'PutAnomalyDetectorOutput'             => [ 'type' => 'structure', 'members' => [], ],
		'PutDashboardInput'                    => [
			'type'     => 'structure',
		...
		'StatusCode'                           => [
			'type' => 'string',
			'enum' => [ 'Complete', 'InternalError', 'PartialData', ],
		],
		'StorageResolution'                    => [ 'type' => 'integer', 'min' => 1, ],
		'Tag'                                  => [
			'type'     => 'structure',
			'required' => [ 'Key', 'Value', ],
			'members'  => [
		...
		'Timestamps'                           => [ 'type' => 'list', 'member' => [ 'shape' => 'Timestamp', ], ],
		...
		'Values'                               => [ 'type' => 'list', 'member' => [ 'shape' => 'DatapointValue', ], ],
	],
];
