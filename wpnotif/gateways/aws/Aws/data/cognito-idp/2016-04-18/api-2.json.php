...
return [
	...
	'shapes'     => [
		...
		'AdminSetUserPasswordResponse'                 => [ 'type' => 'structure', 'members' => [], ],
		...
		'CreateUserPoolDomainResponse'                 => [
			'type'    => 'structure',
			'members' => [ 'CloudFrontDomain' => [ 'shape' => 'DomainType', ], ],
		],
		...
		'CustomDomainConfigType'                       => [
			...
			'members'  => [ 'CertificateArn' => [ 'shape' => 'ArnType', ], ],
		],
		...
		'EventFilterType'                              => [
			'type' => 'string',
			'enum' => [ 'SIGN_IN', 'PASSWORD_CHANGE', 'SIGN_UP', ],
		],
		'EventFiltersType'                             => [
			'type'   => 'list',
		...
		'ListProvidersLimitType'                       => [ 'type' => 'integer', 'max' => 60, 'min' => 0, ],
		...
		'ListTagsForResourceRequest'                   => [
			...
			'members'  => [ 'ResourceArn' => [ 'shape' => 'ArnType', ], ],
		],
		'ListTagsForResourceResponse'                  => [
			'type'    => 'structure',
			'members' => [ 'Tags' => [ 'shape' => 'UserPoolTagsType', ], ],
		],
		...
		'RiskDecisionType'                             => [
			'type' => 'string',
			'enum' => [ 'NoRisk', 'AccountTakeover', 'Block', ],
		],
		...
		'TagKeysType'                                  => [ 'type' => 'string', 'max' => 128, 'min' => 1, ],
		'TagResourceRequest'                           => [
			'type'     => 'structure',
			'required' => [ 'ResourceArn', ],
			'members'  => [
		...
		'TemporaryPasswordValidityDaysType'            => [ 'type' => 'integer', 'max' => 365, 'min' => 0, ],
		'TokenModelType'                               => [
			'type'      => 'string',
			'pattern'   => '[A-Za-z0-9-_=.]+',
			'sensitive' => true,
