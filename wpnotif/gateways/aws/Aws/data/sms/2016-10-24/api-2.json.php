...
return [
	...
	'shapes'     => [
		...
		'AppId'                                     => [ 'type' => 'string', ],
		'AppIds'                                    => [ 'type' => 'list', 'member' => [ 'shape' => 'AppId', ], ],
		'AppLaunchStatus'                           => [
			'type' => 'string',
			'enum' => [
		...
		'Apps'                                      => [ 'type' => 'list', 'member' => [ 'shape' => 'AppSummary', ], ],
		...
		'ConnectorCapability'                       => [
			'type' => 'string',
			'enum' => [ 'VSPHERE', 'SCVMM', 'HYPERV-MANAGER', 'SNAPSHOT_BATCHING', ],
		],
		...
		'ConnectorList'                             => [ 'type' => 'list', 'member' => [ 'shape' => 'Connector', ], ],
		...
		'DeleteAppLaunchConfigurationRequest'       => [
			'type'    => 'structure',
			'members' => [ 'appId' => [ 'shape' => 'AppId', ], ],
		],
		'DeleteAppLaunchConfigurationResponse'      => [ 'type' => 'structure', 'members' => [], ],
		'DeleteAppReplicationConfigurationRequest'  => [
			'type'    => 'structure',
			'members' => [ 'appId' => [ 'shape' => 'AppId', ], ],
		],
		'DeleteAppReplicationConfigurationResponse' => [ 'type' => 'structure', 'members' => [], ],
		'DeleteAppRequest'                          => [
			'type'    => 'structure',
			'members' => [
				'appId'                   => [ 'shape' => 'AppId', ],
		...
		'DeleteAppResponse'                         => [ 'type' => 'structure', 'members' => [], ],
		...
		'DeleteServerCatalogResponse'               => [ 'type' => 'structure', 'members' => [], ],
		...
		'GenerateChangeSetResponse'                 => [
			'type'    => 'structure',
			'members' => [ 's3Location' => [ 'shape' => 'S3Location', ], ],
		],
		...
		'GetAppReplicationConfigurationResponse'    => [
			'type'    => 'structure',
			'members' => [ 'serverGroupReplicationConfigurations' => [ 'shape' => 'ServerGroupReplicationConfigurations', ], ],
		],
		'GetAppRequest'                             => [
			'type'    => 'structure',
			'members' => [ 'appId' => [ 'shape' => 'AppId', ], ],
		...
		'LaunchAppResponse'                         => [ 'type' => 'structure', 'members' => [], ],
		'LaunchDetails'                             => [
			'type'    => 'structure',
			'members' => [
		...
		'LicenseType'                               => [ 'type' => 'string', 'enum' => [ 'AWS', 'BYOL', ], ],
		'ListAppsRequest'                           => [
			'type'    => 'structure',
			'members' => [
				'appIds'     => [ 'shape' => 'AppIds', ],
		...
		'PutAppLaunchConfigurationResponse'         => [ 'type' => 'structure', 'members' => [], ],
		...
		'PutAppReplicationConfigurationResponse'    => [ 'type' => 'structure', 'members' => [], ],
		'ReplicationJob'                            => [
			'type'    => 'structure',
			'members' => [
				'replicationJobId'            => [ 'shape' => 'ReplicationJobId', ],
		...
		'ServerList'                                => [ 'type' => 'list', 'member' => [ 'shape' => 'Server', ], ],
		...
		'StartAppReplicationResponse'               => [ 'type' => 'structure', 'members' => [], ],
		...
		'StopAppReplicationResponse'                => [ 'type' => 'structure', 'members' => [], ],
		'Subnet'                                    => [ 'type' => 'string', ],
		'Tag'                                       => [
			'type'    => 'structure',
			'members' => [
		...
		'TerminateAppResponse'                      => [ 'type' => 'structure', 'members' => [], ],
		...
		'UpdateReplicationJobResponse'              => [ 'type' => 'structure', 'members' => [], ],
		'UserData'                                  => [
			'type'    => 'structure',
			'members' => [ 's3Location' => [ 'shape' => 'S3Location', ], ],
		],
		...
		'VmManagerType'                             => [
			'type' => 'string',
			'enum' => [ 'VSPHERE', 'SCVMM', 'HYPERV-MANAGER', ],
		],
		'VmName'                                    => [ 'type' => 'string', ],
		'VmPath'                                    => [ 'type' => 'string', ],
		'VmServer'                                  => [
