...
return [
	...
	'operations' => [
		'AcceptInvitation'                => [
			...
			'http'   => [ 'method' => 'POST', 'requestUri' => '/master', ],
		...
		'BatchDisableStandards'           => [
			...
			'http'   => [ 'method' => 'POST', 'requestUri' => '/standards/deregister', ],
		...
		'BatchEnableStandards'            => [
			...
			'http'   => [ 'method' => 'POST', 'requestUri' => '/standards/register', ],
		...
		'BatchImportFindings'             => [
			...
			'http'   => [ 'method' => 'POST', 'requestUri' => '/findings/import', ],
		...
		'CreateActionTarget'              => [
			...
			'http'   => [ 'method' => 'POST', 'requestUri' => '/actionTargets', ],
		...
		'CreateInsight'                   => [
			'name'   => 'CreateInsight',
			'http'   => [ 'method' => 'POST', 'requestUri' => '/insights', ],
		...
		'CreateMembers'                   => [
			'name'   => 'CreateMembers',
			'http'   => [ 'method' => 'POST', 'requestUri' => '/members', ],
		...
		'DeclineInvitations'              => [
			...
			'http'   => [ 'method' => 'POST', 'requestUri' => '/invitations/decline', ],
		...
		'DeleteInsight'                   => [
			'name'   => 'DeleteInsight',
			'http'   => [ 'method' => 'DELETE', 'requestUri' => '/insights/{InsightArn+}', ],
		...
		'DeleteInvitations'               => [
			...
			'http'   => [ 'method' => 'POST', 'requestUri' => '/invitations/delete', ],
		...
		'DeleteMembers'                   => [
			'name'   => 'DeleteMembers',
			'http'   => [ 'method' => 'POST', 'requestUri' => '/members/delete', ],
		...
		'DescribeActionTargets'           => [
			...
			'http'   => [ 'method' => 'POST', 'requestUri' => '/actionTargets/get', ],
		...
		'DescribeHub'                     => [
			'name'   => 'DescribeHub',
			'http'   => [ 'method' => 'GET', 'requestUri' => '/accounts', ],
		...
		'DescribeProducts'                => [
			...
			'http'   => [ 'method' => 'GET', 'requestUri' => '/products', ],
		...
		'DisableSecurityHub'              => [
			...
			'http'   => [ 'method' => 'DELETE', 'requestUri' => '/accounts', ],
		...
		'EnableSecurityHub'               => [
			...
			'http'   => [ 'method' => 'POST', 'requestUri' => '/accounts', ],
		...
		'GetEnabledStandards'             => [
			...
			'http'   => [ 'method' => 'POST', 'requestUri' => '/standards/get', ],
		...
		'GetFindings'                     => [
			'name'   => 'GetFindings',
			'http'   => [ 'method' => 'POST', 'requestUri' => '/findings', ],
		...
		'GetInsights'                     => [
			'name'   => 'GetInsights',
			'http'   => [ 'method' => 'POST', 'requestUri' => '/insights/get', ],
		...
		'GetInvitationsCount'             => [
			...
			'http'   => [ 'method' => 'GET', 'requestUri' => '/invitations/count', ],
		...
		'GetMasterAccount'                => [
			...
			'http'   => [ 'method' => 'GET', 'requestUri' => '/master', ],
		...
		'GetMembers'                      => [
			'name'   => 'GetMembers',
			'http'   => [ 'method' => 'POST', 'requestUri' => '/members/get', ],
		...
		'InviteMembers'                   => [
			'name'   => 'InviteMembers',
			'http'   => [ 'method' => 'POST', 'requestUri' => '/members/invite', ],
		...
		'ListMembers'                     => [
			'name'   => 'ListMembers',
			'http'   => [ 'method' => 'GET', 'requestUri' => '/members', ],
	...
	'shapes'     => [
		...
		'ActionTargetList'                        => [ 'type' => 'list', 'member' => [ 'shape' => 'ActionTarget', ], ],
		'ArnList'                                 => [
			'type'   => 'list',
			'member' => [ 'shape' => 'NonEmptyString', ],
		],
		...
		'AwsIamAccessKeyStatus'                   => [ 'type' => 'string', 'enum' => [ 'Active', 'Inactive', ], ],
		'AwsS3BucketDetails'                      => [
			'type'    => 'structure',
			'members' => [
		...
		'BatchDisableStandardsRequest'            => [
			...
			'members'  => [ 'StandardsSubscriptionArns' => [ 'shape' => 'StandardsSubscriptionArns', ], ],
		],
		'BatchDisableStandardsResponse'           => [
			'type'    => 'structure',
			'members' => [ 'StandardsSubscriptions' => [ 'shape' => 'StandardsSubscriptions', ], ],
		],
		'BatchEnableStandardsRequest'             => [
			'type'     => 'structure',
			'required' => [ 'StandardsSubscriptionRequests', ],
			'members'  => [ 'StandardsSubscriptionRequests' => [ 'shape' => 'StandardsSubscriptionRequests', ], ],
		],
		...
		'BatchImportFindingsRequest'              => [
			'type'     => 'structure',
			'required' => [ 'Findings', ],
			'members'  => [ 'Findings' => [ 'shape' => 'AwsSecurityFindingList', ], ],
		],
		...
		'Compliance'                              => [
			'type'    => 'structure',
			'members' => [ 'Status' => [ 'shape' => 'ComplianceStatus', ], ],
		],
		'ComplianceStatus'                        => [
			'type' => 'string',
		...
		'CreateActionTargetResponse'              => [
			...
			'members'  => [ 'ActionTargetArn' => [ 'shape' => 'NonEmptyString', ], ],
		],
		...
		'CreateInsightResponse'                   => [
			'type'     => 'structure',
			'required' => [ 'InsightArn', ],
			'members'  => [ 'InsightArn' => [ 'shape' => 'NonEmptyString', ], ],
		],
		'CreateMembersRequest'                    => [
			'type'    => 'structure',
			'members' => [ 'AccountDetails' => [ 'shape' => 'AccountDetailsList', ], ],
		],
		'CreateMembersResponse'                   => [
			'type'    => 'structure',
			'members' => [ 'UnprocessedAccounts' => [ 'shape' => 'ResultList', ], ],
		],
		'DateFilter'                              => [
			'type'    => 'structure',
			'members' => [
		...
		'DateFilterList'                          => [ 'type' => 'list', 'member' => [ 'shape' => 'DateFilter', ], ],
		'DateRange'                               => [
			'type'    => 'structure',
			'members' => [
				'Value' => [ 'shape' => 'Integer', ],
		...
		'DateRangeUnit'                           => [ 'type' => 'string', 'enum' => [ 'DAYS', ], ],
		...
		'DescribeHubRequest'                      => [
			'type'    => 'structure',
			'members' => [ 'HubArn' => [ 'shape' => 'NonEmptyString', ], ],
		],
		'DescribeHubResponse'                     => [
			'type'    => 'structure',
			'members' => [
		...
		'DisableImportFindingsForProductResponse' => [ 'type' => 'structure', 'members' => [], ],
		'DisableSecurityHubRequest'               => [ 'type' => 'structure', 'members' => [], ],
		'DisableSecurityHubResponse'              => [ 'type' => 'structure', 'members' => [], ],
		'DisassociateFromMasterAccountRequest'    => [ 'type' => 'structure', 'members' => [], ],
		'DisassociateFromMasterAccountResponse'   => [ 'type' => 'structure', 'members' => [], ],
		'DisassociateMembersRequest'              => [
			'type'    => 'structure',
			'members' => [ 'AccountIds' => [ 'shape' => 'AccountIdList', ], ],
		],
		'DisassociateMembersResponse'             => [ 'type' => 'structure', 'members' => [], ],
		'Double'                                  => [ 'type' => 'double', ],
		'EnableImportFindingsForProductRequest'   => [
			'type'     => 'structure',
			'required' => [ 'ProductArn', ],
			'members'  => [ 'ProductArn' => [ 'shape' => 'NonEmptyString', ], ],
		],
		'EnableImportFindingsForProductResponse'  => [
			'type'    => 'structure',
			'members' => [ 'ProductSubscriptionArn' => [ 'shape' => 'NonEmptyString', ], ],
		],
		'EnableSecurityHubRequest'                => [
			'type'    => 'structure',
			'members' => [ 'Tags' => [ 'shape' => 'TagMap', ], ],
		],
		'EnableSecurityHubResponse'               => [ 'type' => 'structure', 'members' => [], ],
		'FieldMap'                                => [
			'type'  => 'map',
		...
		'GetInsightResultsResponse'               => [
			...
			'members'  => [ 'InsightResults' => [ 'shape' => 'InsightResults', ], ],
		],
		'GetInsightsRequest'                      => [
			'type'    => 'structure',
			'members' => [
		...
		'GetInvitationsCountResponse'             => [
			'type'    => 'structure',
			'members' => [ 'InvitationsCount' => [ 'shape' => 'Integer', ], ],
		],
		'GetMasterAccountRequest'                 => [ 'type' => 'structure', 'members' => [], ],
		'GetMasterAccountResponse'                => [
			'type'    => 'structure',
			'members' => [ 'Master' => [ 'shape' => 'Invitation', ], ],
		],
		'GetMembersRequest'                       => [
			'type'     => 'structure',
			'required' => [ 'AccountIds', ],
		...
		'InsightList'                             => [ 'type' => 'list', 'member' => [ 'shape' => 'Insight', ], ],
		'InsightResultValue'                      => [
			'type'     => 'structure',
		...
		'IpFilter'                                => [
			'type'    => 'structure',
			'members' => [ 'Cidr' => [ 'shape' => 'NonEmptyString', ], ],
		],
		'IpFilterList'                            => [ 'type' => 'list', 'member' => [ 'shape' => 'IpFilter', ], ],
		'KeywordFilter'                           => [
			'type'    => 'structure',
			'members' => [ 'Value' => [ 'shape' => 'NonEmptyString', ], ],
		],
		'KeywordFilterList'                       => [ 'type' => 'list', 'member' => [ 'shape' => 'KeywordFilter', ], ],
		...
		'MalwareList'                             => [ 'type' => 'list', 'member' => [ 'shape' => 'Malware', ], ],
		'MalwareState'                            => [
			'type' => 'string',
			'enum' => [ 'OBSERVED', 'REMOVAL_FAILED', 'REMOVED', ],
		],
		'MalwareType'                             => [
			'type' => 'string',
			'enum' => [
		...
		'MapFilterComparison'                     => [ 'type' => 'string', 'enum' => [ 'EQUALS', ], ],
		'MapFilterList'                           => [ 'type' => 'list', 'member' => [ 'shape' => 'MapFilter', ], ],
		...
		'MemberList'                              => [ 'type' => 'list', 'member' => [ 'shape' => 'Member', ], ],
		'Network'                                 => [
			'type'    => 'structure',
			'members' => [
		...
		'NetworkDirection'                        => [ 'type' => 'string', 'enum' => [ 'IN', 'OUT', ], ],
		...
		'NumberFilterList'                        => [ 'type' => 'list', 'member' => [ 'shape' => 'NumberFilter', ], ],
		'Partition'                               => [
			'type' => 'string',
		...
		'ProductsList'                            => [ 'type' => 'list', 'member' => [ 'shape' => 'Product', ], ],
		'Recommendation'                          => [
			'type'    => 'structure',
			'members' => [
				'Text' => [ 'shape' => 'NonEmptyString', ],
		...
		'RecordState'                             => [ 'type' => 'string', 'enum' => [ 'ACTIVE', 'ARCHIVED', ], ],
		'RelatedFinding'                          => [
			'type'     => 'structure',
		...
		'Remediation'                             => [
			'type'    => 'structure',
			'members' => [ 'Recommendation' => [ 'shape' => 'Recommendation', ], ],
		],
		'Resource'                                => [
			'type'     => 'structure',
			'required' => [ 'Type', 'Id', ],
		...
		'ResourceArn'                             => [ 'type' => 'string', 'pattern' => '^arn:aws:securityhub:.*', ],
		...
		'SortCriteria'                            => [ 'type' => 'list', 'member' => [ 'shape' => 'SortCriterion', ], ],
		'SortCriterion'                           => [
			'type'    => 'structure',
			'members' => [
		...
		'StringFilterComparison'                  => [ 'type' => 'string', 'enum' => [ 'EQUALS', 'PREFIX', ], ],
		'StringFilterList'                        => [ 'type' => 'list', 'member' => [ 'shape' => 'StringFilter', ], ],
		'StringList'                              => [
			'type'   => 'list',
			'member' => [ 'shape' => 'NonEmptyString', ],
		],
		...
		'UpdateActionTargetResponse'              => [ 'type' => 'structure', 'members' => [], ],
		...
		'UpdateFindingsResponse'                  => [ 'type' => 'structure', 'members' => [], ],
		...
		'UpdateInsightResponse'                   => [ 'type' => 'structure', 'members' => [], ],
		'VerificationState'                       => [
			'type' => 'string',
			'enum' => [
				'UNKNOWN',
