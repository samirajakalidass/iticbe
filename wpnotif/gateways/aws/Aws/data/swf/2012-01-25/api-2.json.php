...
return [
	...
	'shapes'     => [
		...
		'CancelTimerFailedCause'                                         => [
			'type' => 'string',
			'enum' => [ 'TIMER_ID_UNKNOWN', 'OPERATION_NOT_PERMITTED', ],
		],
		...
		'ListTagsForResourceOutput'                                      => [
			'type'    => 'structure',
			'members' => [ 'tags' => [ 'shape' => 'ResourceTagList', ], ],
		],
		...
		'ResourceTagValue'                                               => [ 'type' => 'string', 'max' => 256, ],
		...
		'Run'                                                            => [
			'type'    => 'structure',
			'members' => [ 'runId' => [ 'shape' => 'WorkflowRunId', ], ],
		],
