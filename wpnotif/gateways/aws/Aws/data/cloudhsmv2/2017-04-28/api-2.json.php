...
return [
	...
	'shapes'     => [
		...
		'BackupState'                       => [
			'type' => 'string',
			'enum' => [ 'CREATE_IN_PROGRESS', 'READY', 'DELETED', 'PENDING_DELETION', ],
		],
		...
		'CopyBackupToRegionResponse'        => [
			'type'    => 'structure',
			'members' => [ 'DestinationBackup' => [ 'shape' => 'DestinationBackup', ], ],
		],
		...
		'EniId'                             => [ 'type' => 'string', 'pattern' => 'eni-[0-9a-fA-F]{8,17}', ],
		'ExternalAz'                        => [
			'type'    => 'string',
		...
		'HsmId'                             => [ 'type' => 'string', 'pattern' => 'hsm-[2-7a-zA-Z]{11,16}', ],
		'HsmState'                          => [
			'type' => 'string',
			'enum' => [
				'CREATE_IN_PROGRESS',
		...
		'StateMessage'                      => [ 'type' => 'string', 'max' => 300, 'pattern' => '.*', ],
		'String'                            => [ 'type' => 'string', ],
		'Strings'                           => [ 'type' => 'list', 'member' => [ 'shape' => 'String', ], ],
		'SubnetId'                          => [ 'type' => 'string', 'pattern' => 'subnet-[0-9a-fA-F]{8,17}', ],
		'SubnetIds'                         => [
			'type'   => 'list',
		...
		'VpcId'                             => [ 'type' => 'string', 'pattern' => 'vpc-[0-9a-fA-F]', ],
