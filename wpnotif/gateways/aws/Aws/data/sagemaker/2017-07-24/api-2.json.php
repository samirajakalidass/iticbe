...
return [
	...
	'shapes'     => [
		...
		'AccountId'                                          => [ 'type' => 'string', 'pattern' => '^\\d+$', ],
		'AddTagsInput'                                       => [
			'type'     => 'structure',
		...
		'AnnotationConsolidationConfig'                      => [
			...
			'members'  => [ 'AnnotationConsolidationLambdaArn' => [ 'shape' => 'LambdaFunctionArn', ], ],
		],
		'ArnOrName'                                          => [
			'type'    => 'string',
			'max'     => 170,
		...
		'AssemblyType'                                       => [ 'type' => 'string', 'enum' => [ 'None', 'Line', ], ],
		'AttributeName'                                      => [
			'type'    => 'string',
			'max'     => 256,
			'min'     => 1,
		...
		'BooleanOperator'                                    => [ 'type' => 'string', 'enum' => [ 'And', 'Or', ], ],
		'Branch'                                             => [
			'type'    => 'string',
			'max'     => 1024,
			'min'     => 1,
		...
		'CategoricalParameterRangeSpecification'             => [
			'type'     => 'structure',
			'required' => [ 'Values', ],
			'members'  => [ 'Values' => [ 'shape' => 'ParameterValues', ], ],
		],
		...
		'Cents'                                              => [ 'type' => 'integer', 'max' => 99, 'min' => 0, ],
		...
		'CodeRepositorySortBy'                               => [
			'type' => 'string',
			'enum' => [ 'Name', 'CreationTime', 'LastModifiedTime', ],
		],
		...
		'CreateAlgorithmOutput'                              => [
			...
			'members'  => [ 'AlgorithmArn' => [ 'shape' => 'AlgorithmArn', ], ],
		],
		...
		'CreateCodeRepositoryOutput'                         => [
			...
			'members'  => [ 'CodeRepositoryArn' => [ 'shape' => 'CodeRepositoryArn', ], ],
		],
		...
		'CreateCompilationJobResponse'                       => [
			...
			'members'  => [ 'CompilationJobArn' => [ 'shape' => 'CompilationJobArn', ], ],
		],
		...
		'CreateHyperParameterTuningJobResponse'              => [
			...
			'members'  => [ 'HyperParameterTuningJobArn' => [ 'shape' => 'HyperParameterTuningJobArn', ], ],
		],
		...
		'CreateLabelingJobResponse'                          => [
			...
			'members'  => [ 'LabelingJobArn' => [ 'shape' => 'LabelingJobArn', ], ],
		],
		'CreateModelInput'                                   => [
			'type'     => 'structure',
		...
		'CreateModelPackageOutput'                           => [
			...
			'members'  => [ 'ModelPackageArn' => [ 'shape' => 'ModelPackageArn', ], ],
		],
		...
		'CreateNotebookInstanceLifecycleConfigOutput'        => [
			'type'    => 'structure',
			'members' => [ 'NotebookInstanceLifecycleConfigArn' => [ 'shape' => 'NotebookInstanceLifecycleConfigArn', ], ],
		],
		...
		'CreateTransformJobResponse'                         => [
			...
			'members'  => [ 'TransformJobArn' => [ 'shape' => 'TransformJobArn', ], ],
		],
		...
		'CreateWorkteamResponse'                             => [
			'type'    => 'structure',
			'members' => [ 'WorkteamArn' => [ 'shape' => 'WorkteamArn', ], ],
		],
		...
		'DeleteAlgorithmInput'                               => [
			...
			'members'  => [ 'AlgorithmName' => [ 'shape' => 'EntityName', ], ],
		],
		'DeleteCodeRepositoryInput'                          => [
			'type'     => 'structure',
			'required' => [ 'CodeRepositoryName', ],
			'members'  => [ 'CodeRepositoryName' => [ 'shape' => 'EntityName', ], ],
		],
		...
		'DeleteModelPackageInput'                            => [
			'type'     => 'structure',
			'required' => [ 'ModelPackageName', ],
			'members'  => [ 'ModelPackageName' => [ 'shape' => 'EntityName', ], ],
		],
		...
		'DeleteNotebookInstanceLifecycleConfigInput'         => [
			'type'     => 'structure',
			'required' => [ 'NotebookInstanceLifecycleConfigName', ],
			'members'  => [ 'NotebookInstanceLifecycleConfigName' => [ 'shape' => 'NotebookInstanceLifecycleConfigName', ], ],
		],
		'DeleteTagsInput'                                    => [
			'type'     => 'structure',
		...
		'DeleteWorkteamRequest'                              => [
			...
			'members'  => [ 'WorkteamName' => [ 'shape' => 'WorkteamName', ], ],
		],
		'DeleteWorkteamResponse'                             => [
			'type'     => 'structure',
			'required' => [ 'Success', ],
			'members'  => [ 'Success' => [ 'shape' => 'Success', ], ],
		],
		'DeployedImage'                                      => [
			'type'    => 'structure',
			'members' => [
		...
		'DescribeAlgorithmInput'                             => [
			'type'     => 'structure',
			'required' => [ 'AlgorithmName', ],
			'members'  => [ 'AlgorithmName' => [ 'shape' => 'ArnOrName', ], ],
		],
		...
		'DescribeCompilationJobRequest'                      => [
			...
			'members'  => [ 'CompilationJobName' => [ 'shape' => 'EntityName', ], ],
		],
		...
		'DescribeHyperParameterTuningJobRequest'             => [
			...
			'members'  => [ 'HyperParameterTuningJobName' => [ 'shape' => 'HyperParameterTuningJobName', ], ],
		],
		...
		'DescribeLabelingJobRequest'                         => [
			...
			'members'  => [ 'LabelingJobName' => [ 'shape' => 'LabelingJobName', ], ],
		],
		...
		'DescribeModelPackageInput'                          => [
			'type'     => 'structure',
			'required' => [ 'ModelPackageName', ],
			'members'  => [ 'ModelPackageName' => [ 'shape' => 'ArnOrName', ], ],
		],
		...
		'DescribeSubscribedWorkteamResponse'                 => [
			...
			'members'  => [ 'SubscribedWorkteam' => [ 'shape' => 'SubscribedWorkteam', ], ],
		],
		...
		'DescribeTransformJobRequest'                        => [
			...
			'members'  => [ 'TransformJobName' => [ 'shape' => 'TransformJobName', ], ],
		],
		...
		'DescribeWorkteamResponse'                           => [
			'type'     => 'structure',
			'required' => [ 'Workteam', ],
			'members'  => [ 'Workteam' => [ 'shape' => 'Workteam', ], ],
		],
		...
		'Dollars'                                            => [ 'type' => 'integer', 'max' => 1, 'min' => 0, ],
		'EndpointArn'                                        => [
			'type'    => 'string',
			'max'     => 2048,
			'min'     => 20,
		...
		'FailureReason'                                      => [ 'type' => 'string', 'max' => 1024, ],
		'Filter'                                             => [
			'type'     => 'structure',
			'required' => [ 'Name', ],
			'members'  => [
		...
		'GetSearchSuggestionsResponse'                       => [
			'type'    => 'structure',
			'members' => [ 'PropertyNameSuggestions' => [ 'shape' => 'PropertyNameSuggestionList', ], ],
		],
		'GitConfig'                                          => [
			'type'     => 'structure',
		...
		'GitConfigForUpdate'                                 => [
			'type'    => 'structure',
			'members' => [ 'SecretArn' => [ 'shape' => 'SecretArn', ], ],
		],
		'GitConfigUrl'                                       => [
			'type'    => 'string',
			'pattern' => '^https://([^/]+)/?(.*)$',
		...
		'JobReferenceCode'                                   => [ 'type' => 'string', 'min' => 1, 'pattern' => '.+', ],
		...
		'JoinSource'                                         => [ 'type' => 'string', 'enum' => [ 'Input', 'None', ], ],
		'JsonPath'                                           => [ 'type' => 'string', 'max' => 63, 'min' => 0, ],
		'KmsKeyId'                                           => [
			'type'    => 'string',
			'max'     => 2048,
			'pattern' => '.*',
		...
		'LabelCounter'                                       => [ 'type' => 'integer', 'min' => 0, ],
		'LabelCounters'                                      => [
			'type'    => 'structure',
			'members' => [
		...
		'LabelingJobDataAttributes'                          => [
			'type'    => 'structure',
			'members' => [ 'ContentClassifiers' => [ 'shape' => 'ContentClassifiers', ], ],
		],
		'LabelingJobDataSource'                              => [
			'type'     => 'structure',
			'required' => [ 'S3DataSource', ],
			'members'  => [ 'S3DataSource' => [ 'shape' => 'LabelingJobS3DataSource', ], ],
		],
		...
		'LabelingJobResourceConfig'                          => [
			'type'    => 'structure',
			'members' => [ 'VolumeKmsKeyId' => [ 'shape' => 'KmsKeyId', ], ],
		],
		'LabelingJobS3DataSource'                            => [
			'type'     => 'structure',
			'required' => [ 'ManifestS3Uri', ],
			'members'  => [ 'ManifestS3Uri' => [ 'shape' => 'S3Uri', ], ],
		],
		'LabelingJobStatus'                                  => [
			'type' => 'string',
			'enum' => [
		...
		'ListLabelingJobsForWorkteamSortByOptions'           => [ 'type' => 'string', 'enum' => [ 'CreationTime', ], ],
		...
		'ListTagsMaxResults'                                 => [ 'type' => 'integer', 'min' => 50, ],
		'ListTagsOutput'                                     => [
			'type'    => 'structure',
			'members' => [
				'Tags'      => [ 'shape' => 'TagList', ],
		...
		'ListWorkteamsSortByOptions'                         => [
			'type' => 'string',
			'enum' => [ 'Name', 'CreateDate', ],
		],
		'MaxConcurrentTaskCount'                             => [ 'type' => 'integer', 'max' => 1000, 'min' => 1, ],
		'MaxConcurrentTransforms'                            => [ 'type' => 'integer', 'min' => 0, ],
		'MaxHumanLabeledObjectCount'                         => [ 'type' => 'integer', 'min' => 1, ],
		'MaxNumberOfTrainingJobs'                            => [ 'type' => 'integer', 'min' => 1, ],
		'MaxParallelTrainingJobs'                            => [ 'type' => 'integer', 'min' => 1, ],
		'MaxPayloadInMB'                                     => [ 'type' => 'integer', 'min' => 0, ],
		'MaxPercentageOfInputDatasetLabeled'                 => [ 'type' => 'integer', 'max' => 100, 'min' => 1, ],
		'MaxResults'                                         => [ 'type' => 'integer', 'max' => 100, 'min' => 1, ],
		'MaxRuntimeInSeconds'                                => [ 'type' => 'integer', 'min' => 1, ],
		'MemberDefinition'                                   => [
			'type'    => 'structure',
			'members' => [ 'CognitoMemberDefinition' => [ 'shape' => 'CognitoMemberDefinition', ], ],
		],
		'MemberDefinitions'                                  => [
			'type'   => 'list',
		...
		'NotebookInstanceLifecycleConfigArn'                 => [ 'type' => 'string', 'max' => 256, ],
		...
		'NotebookInstanceLifecycleHook'                      => [
			'type'    => 'structure',
			'members' => [ 'Content' => [ 'shape' => 'NotebookInstanceLifecycleConfigContent', ], ],
		],
		'NotebookInstanceName'                               => [
			'type'    => 'string',
			'max'     => 63,
		...
		'NotebookInstanceVolumeSizeInGB'                     => [ 'type' => 'integer', 'max' => 16384, 'min' => 5, ],
		'NotificationConfiguration'                          => [
			'type'    => 'structure',
			'members' => [ 'NotificationTopicArn' => [ 'shape' => 'NotificationTopicArn', ], ],
		],
		'NotificationTopicArn'                               => [
			'type'    => 'string',
			'pattern' => 'arn:aws[a-z\\-]*:sns:[a-z0-9\\-]*:[0-9]{12}:[a-zA-Z0-9_.-]*',
		],
		'NumberOfHumanWorkersPerDataObject'                  => [ 'type' => 'integer', 'max' => 9, 'min' => 1, ],
		'ObjectiveStatus'                                    => [
			'type' => 'string',
			'enum' => [ 'Succeeded', 'Pending', 'Failed', ],
		],
		'ObjectiveStatusCounter'                             => [ 'type' => 'integer', 'min' => 0, ],
		'ObjectiveStatusCounters'                            => [
			'type'    => 'structure',
			'members' => [
		...
		'PropertyNameQuery'                                  => [
			...
			'members'  => [ 'PropertyNameHint' => [ 'shape' => 'PropertyNameHint', ], ],
		],
		'PropertyNameSuggestion'                             => [
			'type'    => 'structure',
			'members' => [ 'PropertyName' => [ 'shape' => 'ResourcePropertyName', ], ],
		],
		...
		'ResourceInUse'                                      => [
			'type'      => 'structure',
			'members'   => [ 'Message' => [ 'shape' => 'FailureReason', ], ],
			'exception' => true,
		],
		...
		'ResourceType'                                       => [ 'type' => 'string', 'enum' => [ 'TrainingJob', ], ],
		'ResponseMIMEType'                                   => [
			'type'    => 'string',
			'max'     => 1024,
			'pattern' => '^[-\\w]+\\/.+$',
		...
		'SearchRecord'                                       => [
			'type'    => 'structure',
			'members' => [ 'TrainingJob' => [ 'shape' => 'TrainingJob', ], ],
		],
		'SearchRequest'                                      => [
			'type'     => 'structure',
			'required' => [ 'Resource', ],
		...
		'SourceAlgorithmSpecification'                       => [
			...
			'members'  => [ 'SourceAlgorithms' => [ 'shape' => 'SourceAlgorithmList', ], ],
		],
		'SplitType'                                          => [
			'type' => 'string',
		...
		'SuggestionQuery'                                    => [
			'type'    => 'structure',
			'members' => [ 'PropertyNameQuery' => [ 'shape' => 'PropertyNameQuery', ], ],
		],
		'Tag'                                                => [
			'type'     => 'structure',
			'required' => [ 'Key', 'Value', ],
		...
		'TaskAvailabilityLifetimeInSeconds'                  => [ 'type' => 'integer', 'max' => 864000, 'min' => 1, ],
		'TaskCount'                                          => [ 'type' => 'integer', 'min' => 1, ],
		'TaskDescription'                                    => [
			'type'    => 'string',
			'max'     => 255,
			'min'     => 1,
		...
		'TaskTimeLimitInSeconds'                             => [ 'type' => 'integer', 'max' => 28800, 'min' => 1, ],
		'TaskTitle'                                          => [
			'type'    => 'string',
			'max'     => 128,
			'min'     => 1,
		...
		'TenthFractionsOfACent'                              => [ 'type' => 'integer', 'max' => 9, 'min' => 0, ],
		'Timestamp'                                          => [ 'type' => 'timestamp', ],
		'TrainingInputMode'                                  => [ 'type' => 'string', 'enum' => [ 'Pipe', 'File', ], ],
		'TrainingInstanceCount'                              => [ 'type' => 'integer', 'min' => 1, ],
		...
		'TrainingJobEarlyStoppingType'                       => [ 'type' => 'string', 'enum' => [ 'Off', 'Auto', ], ],
		'TrainingJobName'                                    => [
			'type'    => 'string',
			'max'     => 63,
			'min'     => 1,
		...
		'TrainingJobStatusCounter'                           => [ 'type' => 'integer', 'min' => 0, ],
		'TrainingJobStatusCounters'                          => [
			'type'    => 'structure',
			'members' => [
		...
		'TransformDataSource'                                => [
			'type'     => 'structure',
			'required' => [ 'S3DataSource', ],
			'members'  => [ 'S3DataSource' => [ 'shape' => 'TransformS3DataSource', ], ],
		],
		...
		'TransformInstanceCount'                             => [ 'type' => 'integer', 'min' => 1, ],
		...
		'UiConfig'                                           => [
			...
			'members'  => [ 'UiTemplateS3Uri' => [ 'shape' => 'S3Uri', ], ],
		],
		'UiTemplate'                                         => [
			'type'     => 'structure',
			'required' => [ 'Content', ],
			'members'  => [ 'Content' => [ 'shape' => 'TemplateContent', ], ],
		],
		...
		'UpdateNotebookInstanceLifecycleConfigOutput'        => [ 'type' => 'structure', 'members' => [], ],
		...
		'VariantWeight'                                      => [ 'type' => 'float', 'min' => 0, ],
		'VolumeSizeInGB'                                     => [ 'type' => 'integer', 'min' => 1, ],
		'VpcConfig'                                          => [
			'type'     => 'structure',
