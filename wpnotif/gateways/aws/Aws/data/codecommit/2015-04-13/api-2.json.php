...
return [
	...
	'shapes'     => [
		...
		'DeleteBranchOutput'                                => [
			'type'    => 'structure',
			'members' => [ 'deletedBranch' => [ 'shape' => 'BranchInfo', ], ],
		],
		...
		'Description'                                       => [ 'type' => 'string', 'max' => 10240, ],
		'Difference'                                        => [
			'type'    => 'structure',
			'members' => [
		...
		'FileContent'                                       => [ 'type' => 'blob', 'max' => 6291456, ],
		...
		'GetBranchOutput'                                   => [
			'type'    => 'structure',
			'members' => [ 'branch' => [ 'shape' => 'BranchInfo', ], ],
		],
		'GetCommentInput'                                   => [
			'type'     => 'structure',
			'required' => [ 'commentId', ],
