...
return [
	...
	'operations' => [
		...
		'CreateGroup'                    => [
			'name'   => 'CreateGroup',
			'http'   => [ 'method' => 'POST', 'requestUri' => '/CreateGroup', ],
		...
		'CreateSamplingRule'             => [
			...
			'http'   => [ 'method' => 'POST', 'requestUri' => '/CreateSamplingRule', ],
		...
		'DeleteGroup'                    => [
			'name'   => 'DeleteGroup',
			'http'   => [ 'method' => 'POST', 'requestUri' => '/DeleteGroup', ],
		...
		'DeleteSamplingRule'             => [
			...
			'http'   => [ 'method' => 'POST', 'requestUri' => '/DeleteSamplingRule', ],
		...
		'GetEncryptionConfig'            => [
			...
			'http'   => [ 'method' => 'POST', 'requestUri' => '/EncryptionConfig', ],
		...
		'GetGroup'                       => [
			'name'   => 'GetGroup',
			'http'   => [ 'method' => 'POST', 'requestUri' => '/GetGroup', ],
		...
		'GetSamplingRules'               => [
			...
			'http'   => [ 'method' => 'POST', 'requestUri' => '/GetSamplingRules', ],
		...
		'GetSamplingTargets'             => [
			...
			'http'   => [ 'method' => 'POST', 'requestUri' => '/SamplingTargets', ],
		...
		'UpdateGroup'                    => [
			'name'   => 'UpdateGroup',
			'http'   => [ 'method' => 'POST', 'requestUri' => '/UpdateGroup', ],
	...
	'shapes'     => [
		...
		'AttributeKey'                          => [ 'type' => 'string', 'max' => 32, 'min' => 1, ],
		'AttributeMap'                          => [
			'type'  => 'map',
		...
		'AttributeValue'                        => [ 'type' => 'string', 'max' => 32, 'min' => 1, ],
		...
		'BorrowCount'                           => [ 'type' => 'integer', 'min' => 0, ],
		'ClientID'                              => [ 'type' => 'string', 'max' => 24, 'min' => 24, ],
		'CreateGroupRequest'                    => [
			'type'     => 'structure',
			'required' => [ 'GroupName', ],
			'members'  => [
		...
		'CreateSamplingRuleRequest'             => [
			...
			'members'  => [ 'SamplingRule' => [ 'shape' => 'SamplingRule', ], ],
		],
		'CreateSamplingRuleResult'              => [
			'type'    => 'structure',
			'members' => [ 'SamplingRuleRecord' => [ 'shape' => 'SamplingRuleRecord', ], ],
		],
		'DeleteGroupRequest'                    => [
			'type'    => 'structure',
			'members' => [
		...
		'DeleteGroupResult'                     => [ 'type' => 'structure', 'members' => [], ],
		...
		'Double'                                => [ 'type' => 'double', ],
		'EC2InstanceId'                         => [ 'type' => 'string', 'max' => 20, ],
		'Edge'                                  => [
			'type'    => 'structure',
			'members' => [
		...
		'EncryptionKeyId'                       => [ 'type' => 'string', 'max' => 3000, 'min' => 1, ],
		'EncryptionStatus'                      => [ 'type' => 'string', 'enum' => [ 'UPDATING', 'ACTIVE', ], ],
		'EncryptionType'                        => [ 'type' => 'string', 'enum' => [ 'NONE', 'KMS', ], ],
		'EntitySelectorExpression'              => [ 'type' => 'string', 'max' => 500, 'min' => 1, ],
		'ErrorMessage'                          => [ 'type' => 'string', ],
		'ErrorRootCause'                        => [
			'type'    => 'structure',
			'members' => [ 'Services' => [ 'shape' => 'ErrorRootCauseServices', ], ],
		],
		...
		'ErrorRootCauses'                       => [ 'type' => 'list', 'member' => [ 'shape' => 'ErrorRootCause', ], ],
		'ErrorStatistics'                       => [
			'type'    => 'structure',
			'members' => [
		...
		'FaultRootCause'                        => [
			'type'    => 'structure',
			'members' => [ 'Services' => [ 'shape' => 'FaultRootCauseServices', ], ],
		],
		...
		'FaultRootCauses'                       => [ 'type' => 'list', 'member' => [ 'shape' => 'FaultRootCause', ], ],
		'FaultStatistics'                       => [
			'type'    => 'structure',
			'members' => [
				'OtherCount' => [ 'shape' => 'NullableLong', ],
		...
		'FixedRate'                             => [ 'type' => 'double', 'max' => 1, 'min' => 0, ],
		'GetEncryptionConfigRequest'            => [ 'type' => 'structure', 'members' => [], ],
		'GetEncryptionConfigResult'             => [
			'type'    => 'structure',
			'members' => [ 'EncryptionConfig' => [ 'shape' => 'EncryptionConfig', ], ],
		],
		'GetGroupRequest'                       => [
			'type'    => 'structure',
			'members' => [
		...
		'GetGroupsNextToken'                    => [ 'type' => 'string', 'max' => 100, 'min' => 1, ],
		'GetGroupsRequest'                      => [
			'type'    => 'structure',
			'members' => [ 'NextToken' => [ 'shape' => 'GetGroupsNextToken', ], ],
		],
		'GetGroupsResult'                       => [
			'type'    => 'structure',
			'members' => [
		...
		'GetSamplingTargetsRequest'             => [
			...
			'members'  => [ 'SamplingStatisticsDocuments' => [ 'shape' => 'SamplingStatisticsDocumentList', ], ],
		],
		...
		'GroupARN'                              => [ 'type' => 'string', 'max' => 400, 'min' => 1, ],
		'GroupName'                             => [ 'type' => 'string', 'max' => 32, 'min' => 1, ],
		'GroupSummary'                          => [
			'type'    => 'structure',
			'members' => [
				'GroupName'        => [ 'shape' => 'String', ],
		...
		'Priority'                              => [ 'type' => 'integer', 'max' => 9999, 'min' => 1, ],
		...
		'RequestCount'                          => [ 'type' => 'integer', 'min' => 0, ],
		'ReservoirSize'                         => [ 'type' => 'integer', 'min' => 0, ],
		'ResourceARN'                           => [ 'type' => 'string', 'max' => 500, ],
		'ResourceARNDetail'                     => [
			'type'    => 'structure',
			'members' => [ 'ARN' => [ 'shape' => 'String', ], ],
		],
		'ResponseTimeRootCause'                 => [
			'type'    => 'structure',
			'members' => [ 'Services' => [ 'shape' => 'ResponseTimeRootCauseServices', ], ],
		],
		...
		'RuleName'                              => [ 'type' => 'string', 'max' => 32, 'min' => 1, ],
		'SampledCount'                          => [ 'type' => 'integer', 'min' => 0, ],
		'SamplingRule'                          => [
			'type'     => 'structure',
			'required' => [
				'ResourceARN',
		...
		'SamplingStrategyName'                  => [ 'type' => 'string', 'enum' => [ 'PartialScan', 'FixedRate', ], ],
		...
		'ServiceName'                           => [ 'type' => 'string', 'max' => 64, ],
		...
		'ServiceType'                           => [ 'type' => 'string', 'max' => 64, ],
		'String'                                => [ 'type' => 'string', ],
		'TelemetryRecord'                       => [
			'type'     => 'structure',
			'required' => [ 'Timestamp', ],
		...
		'TimeRangeType'                         => [ 'type' => 'string', 'enum' => [ 'TraceId', 'Event', ], ],
		...
		'UpdateSamplingRuleRequest'             => [
			...
			'members'  => [ 'SamplingRuleUpdate' => [ 'shape' => 'SamplingRuleUpdate', ], ],
		],
