...
return [
	...
	'operations' => [
		'CreateBroker'                  => [
			...
			'input'  => [ 'shape' => 'CreateBrokerRequest', ],
			'output' => [ 'shape' => 'CreateBrokerResponse', ],
			'errors' => [
		...
		'DeleteBroker'                  => [
			...
			'input'  => [ 'shape' => 'DeleteBrokerRequest', ],
			'output' => [ 'shape' => 'DeleteBrokerResponse', ],
			'errors' => [
				[ 'shape' => 'NotFoundException', ],
				[ 'shape' => 'BadRequestException', ],
				[ 'shape' => 'InternalServerErrorException', ],
		...
		'DescribeBroker'                => [
			...
			'input'  => [ 'shape' => 'DescribeBrokerRequest', ],
			'output' => [ 'shape' => 'DescribeBrokerResponse', ],
			'errors' => [
				[ 'shape' => 'NotFoundException', ],
				[ 'shape' => 'BadRequestException', ],
				[ 'shape' => 'InternalServerErrorException', ],
		...
		'DescribeBrokerEngineTypes'     => [
			...
			'input'  => [ 'shape' => 'DescribeBrokerEngineTypesRequest', ],
			'output' => [ 'shape' => 'DescribeBrokerEngineTypesResponse', ],
			'errors' => [
				[ 'shape' => 'BadRequestException', ],
				[ 'shape' => 'InternalServerErrorException', ],
				[ 'shape' => 'ForbiddenException', ],
		...
		'DescribeBrokerInstanceOptions' => [
			...
			'input'  => [ 'shape' => 'DescribeBrokerInstanceOptionsRequest', ],
			'output' => [ 'shape' => 'DescribeBrokerInstanceOptionsResponse', ],
			'errors' => [
				[ 'shape' => 'BadRequestException', ],
				[ 'shape' => 'InternalServerErrorException', ],
				[ 'shape' => 'ForbiddenException', ],
		...
		'ListBrokers'                   => [
			...
			'input'  => [ 'shape' => 'ListBrokersRequest', ],
			'output' => [ 'shape' => 'ListBrokersResponse', ],
			'errors' => [
				[ 'shape' => 'BadRequestException', ],
				[ 'shape' => 'InternalServerErrorException', ],
				[ 'shape' => 'ForbiddenException', ],
		...
		'RebootBroker'                  => [
			...
			'output' => [ 'shape' => 'RebootBrokerResponse', ],
			'errors' => [
				[ 'shape' => 'NotFoundException', ],
				[ 'shape' => 'BadRequestException', ],
				[ 'shape' => 'InternalServerErrorException', ],
		...
		'UpdateBroker'                  => [
			...
			'input'  => [ 'shape' => 'UpdateBrokerRequest', ],
			'output' => [ 'shape' => 'UpdateBrokerResponse', ],
			'errors' => [
				[ 'shape' => 'NotFoundException', ],
				[ 'shape' => 'BadRequestException', ],
				[ 'shape' => 'InternalServerErrorException', ],
	...
	'shapes'     => [
		...
		'CreateBrokerInput'                     => [
			...
			'members' => [
				...
				'Logs'                       => [ 'shape' => 'Logs', 'locationName' => 'logs', ],
				...
				'SecurityGroups'             => [ 'shape' => '__listOf__string', 'locationName' => 'securityGroups', ],
				'SubnetIds'                  => [ 'shape' => '__listOf__string', 'locationName' => 'subnetIds', ],
				'Tags'                       => [ 'shape' => '__mapOf__string', 'locationName' => 'tags', ],
				'Users'                      => [ 'shape' => '__listOfUser', 'locationName' => 'users', ],
			],
		],
		'CreateBrokerOutput'                    => [
			'type'    => 'structure',
		...
		'CreateUserResponse'                    => [ 'type' => 'structure', 'members' => [], ],
		'DayOfWeek'                             => [
			'type' => 'string',
			'enum' => [
				'MONDAY',
		...
		'DescribeBrokerOutput'                  => [
			...
			'members' => [
				...
				'Created'                    => [ 'shape' => '__timestampIso8601', 'locationName' => 'created', ],
				'DeploymentMode'             => [ 'shape' => 'DeploymentMode', 'locationName' => 'deploymentMode', ],
				'EngineType'                 => [ 'shape' => 'EngineType', 'locationName' => 'engineType', ],
				'EngineVersion'              => [ 'shape' => '__string', 'locationName' => 'engineVersion', ],
				'HostInstanceType'           => [ 'shape' => '__string', 'locationName' => 'hostInstanceType', ],
				'Logs'                       => [ 'shape' => 'LogsSummary', 'locationName' => 'logs', ],
				'MaintenanceWindowStartTime' => [
					'shape'        => 'WeeklyStartTime',
					'locationName' => 'maintenanceWindowStartTime',
				],
				'PendingEngineVersion'       => [ 'shape' => '__string', 'locationName' => 'pendingEngineVersion', ],
				'PubliclyAccessible'         => [ 'shape' => '__boolean', 'locationName' => 'publiclyAccessible', ],
				'SecurityGroups'             => [ 'shape' => '__listOf__string', 'locationName' => 'securityGroups', ],
				'SubnetIds'                  => [ 'shape' => '__listOf__string', 'locationName' => 'subnetIds', ],
				'Tags'                       => [ 'shape' => '__mapOf__string', 'locationName' => 'tags', ],
				'Users'                      => [ 'shape' => '__listOfUserSummary', 'locationName' => 'users', ],
			],
		],
		...
		'EngineType'                            => [ 'type' => 'string', 'enum' => [ 'ACTIVEMQ', ], ],
		'EngineVersion'                         => [
			'type'    => 'structure',
			'members' => [
				'Name' => [
		...
		'RebootBrokerResponse'                  => [ 'type' => 'structure', 'members' => [], ],
		'SanitizationWarning'                   => [
			'type'    => 'structure',
			'members' => [
				'AttributeName' => [
		...
		'UpdateUserResponse'                    => [ 'type' => 'structure', 'members' => [], ],
		'User'                                  => [
			'type'    => 'structure',
			'members' => [
				'ConsoleAccess' => [
		...
		'__integerMin5Max100'                   => [ 'type' => 'integer', 'min' => 5, 'max' => 100, ],
		...
		'__listOfBrokerEngineType'              => [
			'type'   => 'list',
			'member' => [ 'shape' => 'BrokerEngineType', ],
		],
		'__listOfBrokerInstance'                => [ 'type' => 'list', 'member' => [ 'shape' => 'BrokerInstance', ], ],
		'__listOfBrokerInstanceOption'          => [
			'type'   => 'list',
			'member' => [ 'shape' => 'BrokerInstanceOption', ],
		],
		'__listOfBrokerSummary'                 => [ 'type' => 'list', 'member' => [ 'shape' => 'BrokerSummary', ], ],
		'__listOfConfiguration'                 => [ 'type' => 'list', 'member' => [ 'shape' => 'Configuration', ], ],
		'__listOfConfigurationId'               => [ 'type' => 'list', 'member' => [ 'shape' => 'ConfigurationId', ], ],
		'__listOfConfigurationRevision'         => [
			'type'   => 'list',
			'member' => [ 'shape' => 'ConfigurationRevision', ],
		],
		'__listOfEngineVersion'                 => [ 'type' => 'list', 'member' => [ 'shape' => 'EngineVersion', ], ],
		'__listOfSanitizationWarning'           => [
			'type'   => 'list',
			'member' => [ 'shape' => 'SanitizationWarning', ],
		],
		'__listOfUser'                          => [ 'type' => 'list', 'member' => [ 'shape' => 'User', ], ],
		'__listOfUserSummary'                   => [ 'type' => 'list', 'member' => [ 'shape' => 'UserSummary', ], ],
